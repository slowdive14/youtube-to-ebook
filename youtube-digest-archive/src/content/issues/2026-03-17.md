---
title: "YouTube Digest — 2026-03-17"
date: 2026-03-17
subject: "\"50 AI Agents Running My Company\" Is a Lie. Here's How I Build It | Gumloop, Max Brodeur-Urbas & 2 more"
audioUrls:
  - "https://pub-627e42d23de845169be239bf2f1b52ad.r2.dev/audio/2026/03/17/Podcast_20260317_EN.m4a"
articles:
  ...
  - title: "From journalist to app developer using Claude Code"
    channel: "How I AI"
    url: "https://www.youtube.com/watch?v=HbWu_eYIHKQ"
...
## English
> Based on **""50 AI Agents Running My Company" Is a Lie. Here's How I Build It | Gumloop, Max Brodeur-Urbas"** from **EO**
> [Watch the original video](https://www.youtube.com/watch?v=CxFQykWiJqY)
...
[[SUM]] Max's journey began with disillusionment at Microsoft, finding Big Tech advice a "cope" and his early twenties "wasted"; his entrepreneurial push was solidified by an unexpected deportation and a five-year U.S. ban, forcing him to build a company without a fallback.
...
[[SUM]] For six months, Max relentlessly built and tried to sell numerous MVPs, learning that founders should "hunt for someone to tell you why this won't work" to validate ideas, as he wouldn't have built Gumloop without 10 prior failures.
...
[[SUM]] Max initially built AgentHub to simplify AutoGPT, but the "aha! moment" came when he realized users wanted "reliability, predictability" over unreliable agents, leading him to develop an automation platform for non-technical business users.
...
[[SUM]] During Y Combinator, Max's ban-induced isolation in Canada fostered intense focus, proving that "the people who are actually building something amazing are not at those events" and that building something exceptional attracts investment and talent.
...
[[SUM]] Max emphasizes using AI to accelerate what you already understand, not to shortcut understanding, warning that "vibe coding" or using AI without comprehension leads to "uncertainty" and a "slippery slope" for those who skip learning.
...
[[SUM]] Gumloop's hiring strategy focuses on converting customers into employees, as they already possess "conviction" and are "equally excited about the mission," fostering a culture of genuine enthusiasm without rigid hours.
...
[[SUM]] Max argues that building a successful company requires "blind confidence" and a willingness to take risks and prove others wrong, rather than obsessing over "moats" or big competitors like Zapier or OpenAI.
...
---
> Based on **"From journalist to app developer using Claude Code"** from **How I AI**
> [Watch the original video](https://www.youtube.com/watch?v=HbWu_eYIHKQ)
...
[[SUM]] Veteran journalist Dan Roth, familiar with the disruption blogging brought to publishing, recognized a similar democratizing power in generative AI for coding, transforming his role from influencing ideas to building them himself, leading to an obsession with app development.
...
[[SUM]] Roth's development process uses two distinct Claude Code AI agents: Bob the Builder, who plans, builds modularly, and documents everything, and Ray the Reviewer, a senior engineer focused on security and architectural integrity with the power to reject Bob's proposals, with Roth acting as the tie-breaker and manager.
...
[[SUM]] Roth defines his role as a "picky customer" or "vibe coder," focusing on user experience, product voice, and core functionality from a personal standpoint, ensuring the app reflects his specific desires rather than traditional PM or architect roles.
...
[[SUM]] His app, Commutely, born from a personal need to track NYC train times, exemplifies his "picky customer" philosophy, using iOS Live Activity for real-time updates and managing feature requests through a separate Claude chat that ranks ideas for implementation by Bob and Ray.
...
[[SUM]] Roth's workflow involves logging everything in markdown, using separate Claude tabs for Bob and Ray to introduce intentional friction for learning, strictly adhering to planning, modular building, and branching, and managing AI like a "hungover intern" by constantly reminding it of context and limitations, with the App Store submission process being the greatest remaining friction.

Roth's workflow is rich with practical tips for anyone looking to leverage AI in development:

1.  **Log Everything in Markdown:** To combat AI's "context window" limitations and his own weekend-only memory, Roth saves all interactions, plans, and code snippets in markdown files. This ensures continuous context for both him and his AI agents.
2.  **Separate Agents, Separate Tabs:** Running Bob and Ray in distinct Claude tabs provides transparency. When Bob needs Ray's approval, Roth copies Bob's output into Ray's tab. This manual step, though seemingly inefficient, is intentional. "Putting a little bit of friction in the process where you're actually forced to like copy and paste, put it over, read what Ray says... does help with learning," he notes.
3.  **Plan, Module, Branch:** Bob is strictly instructed to plan thoroughly, build in reusable modules, and always work in separate code branches. Roth learned the hard way about the perils of merging directly to the main codebase.
...
5.  **Navigating the App Store:** The greatest remaining friction, Roth finds, is the Apple App Store submission process. He even envisions an AI tool specifically for App Store designs and metadata, simplifying what he calls "almost the last friction left in being a builder."

## Beyond Coding: AI as a Daily Productivity Co-pilot

[[SUM]] Beyond app development, Roth leverages Copilot daily as an editor to manage his 400-person team, using prompts like "What did I drop the ball on?" to identify unaddressed tasks across Outlook, Teams, and files, ensuring he starts each day with a clean slate.
...
His favorite daily prompt, executed before he leaves work, is "What did I drop the ball on?"
"It's going to go through Outlook. It's going to go through Teams. It's going to go through any updated files," he explains. Copilot identifies unresponded emails, unaddressed team messages, or neglected projects he's been following. This "evening nightly nudge" allows him to wrap up loose ends, ensuring he starts the next day with a clean slate. "This is my savior," he declares, "This is like what I count on AI to be able to do to make me better at my job so that I can spend the weekends building money losing apps like Commutely."

## The Human-AI Partnership: Assuming Best Intentions

[[SUM]] Roth interacts with AI using direct commands, avoiding pleasantries, and when AI underperforms, he reminds it of past discussions, operating on the principle of "assume best intentions" to guide the AI with clarity and grace, much like managing a team.
...
---
> Based on **"A War Within the War: Israel’s Bombardment of Lebanon"** from **New York Times Podcasts**
> [Watch the original video](https://www.youtube.com/watch?v=wwty6NW9Gs0)
...
[[SUM]] Beirut's southern suburbs are "completely cratered" by Israeli bombardment, displacing over a million people in a nation of 5.8 million, with 800+ fatalities, dragging Lebanon into another major war.
...
[[SUM]] Israeli rhetoric and a massive troop buildup suggest a deeper objective beyond retaliation, with Defense Minister Gallant warning Beirut's Dahiyeh will look like Khan Younis, signaling intent to alter the security landscape.
...
[[SUM]] Hezbollah, a formidable political party and "state within a state," has shown surprising resilience, rebuilding arms and integrating IRGC members, proving it used the ceasefire to prepare for this major conflict.
...
[[SUM]] Hezbollah's traditional support base, exhausted from repeated wars and displacement, is now questioning if the cost borne by the Shia community is worth it, especially regarding the response to a foreign leader's killing.
...
[[SUM]] Lebanon's dysfunctional government is in an impossible bind, as the U.S. has allowed Israeli bombardment and pressures Lebanon to disarm Hezbollah, a move that risks civil war and reflects a dissipated U.S. tempering influence.
...
[[SUM]] Israel's goal to eliminate Hezbollah, coupled with a massive troop buildup, suggests a ground invasion to create a larger buffer zone, mirroring Gaza's conflict with "much more permanent" aims for Lebanon.
...
## 한국어
> **""50 AI Agents Running My Company" Is a Lie. Here's How I Build It | Gumloop, Max Brodeur-Urbas"** — **EO** 기반 기사
> [원본 영상 보기](https://www.youtube.com/watch?v=CxFQykWiJqY)
...
[[SUM]] 맥스 CEO는 '50개 AI 에이전트가 회사를 운영한다'는 주장은 대부분 거짓 마케팅이며, 힘든 노력을 건너뛰고 지름길로 가치를 얻으려는 환상에 불과하다고 비판합니다.
...
[[SUM]] 맥스 CEO는 빅테크의 '황금 수갑'에 갇히지 않고 21~23세의 젊은 시절에 바로 창업을 시작한 것이 옳았다고 회고하며, 빅테크 경험이 스타트업에 도움이 되지 않았다고 말합니다.
...
[[SUM]] 미국 국경에서 추방당한 후 맥스 CEO는 6개월간 수많은 MVP를 만들며 '내가 틀렸음을 증명하는 것'을 쫓아 실패를 통해 배우는 것이 스타트업 성공의 핵심임을 깨달았습니다.
...
[[SUM]] AutoGPT 사용자들의 '신뢰성'과 '예측 가능성' 요구를 파악한 맥스 CEO는 이를 바탕으로 비기술적인 비즈니스 관리자들도 쉽게 AI 자동화를 할 수 있는 Gumloop을 개발했습니다.
...
[[SUM]] Gumloop은 YC 기간 동안 월 20달러의 첫 유료 고객을 확보했으며, 맥스 CEO는 네트워킹보다 '놀라운 것을 만드는' 것에 집중하는 것이 투자 유치에 더 중요하다고 강조합니다.
...
[[SUM]] 맥스 CEO는 AI를 깊이 이해하는 분야에 적용하여 반복 작업을 자동화하고 능력을 극대화해야 하며, AI를 이해 없이 사용하면 '슬롭'을 만들게 될 것이라고 경고합니다.
...
[[SUM]] Gumloop은 기존 고객 등 네트워크를 통해 탁월한 인재들을 채용했으며, 회사가 매력적인 곳이 되어야 최고의 인재들이 자발적으로 합류하고 미션에 기여한다고 설명합니다.
...
[[SUM]] 맥스 CEO는 대기업이 더 잘할 것이라는 수많은 이유에도 불구하고 '그냥 시도하고, 성공하고, 실패하면 다시 시도하는' 맹목적인 자신감이 창업을 가능하게 한다고 말합니다.
...
---
> **"From journalist to app developer using Claude Code"** — **How I AI** 기반 기사
> [원본 영상 보기](https://www.youtube.com/watch?v=HbWu_eYIHKQ)

# 기자에서 앱 개발자로: AI 비서 '밥'과 '레이'로 앱스토어 정복한 댄 로스의 '바이브 코딩' 비법

**[도입부]**
링키드인(LinkedIn) 편집장 댄 로스(Dan Roth)는 그의 경력을 비즈니스 작가이자 편집자로 시작했습니다. 하지만 이제 그는 AI 도구, 특히 클로드 코드(Claude Code)를 활용하여 iOS 앱을 개발하고 앱스토어에 출시하는 '바이브 코딩(vibe coding)' 전문가로 변모했습니다. 비기술적 배경을 가진 그가 어떻게 고품질의 프로덕션 수준 소프트웨어를 구축할 수 있었을까요? 그 비결은 바로 '밥(Bob)'과 '레이(Ray)'라는 두 명의 AI 에이전트를 활용한 독특한 협업 시스템에 있습니다. 이번 기사에서는 댄 로스의 혁신적인 개발 철학과 워크플로우를 자세히 들여다봅니다.

---

### 1. 언론인의 AI 시대 적응기: '모두의 개발' 시대 개척자

[[SUM]] 댄 로스는 워드프레스가 글쓰기를 대중화했듯, 생성형 AI가 코딩을 대중화하여 누구나 아이디어를 직접 구현할 수 있게 되면서 앱 개발에 몰두하게 되었다.
...
[[SUM]] 로스는 '까다로운 고객'으로서 '바이브 코딩'을 하며, 코드를 구축하는 '밥'과 보안 및 아키텍처를 검토하는 '레이'라는 두 AI 에이전트를 활용해 개발한다.
...
**가. 빌더 에이전트 '밥(Bob)'**
'밥 더 빌더(Bob the Builder)'라는 별명을 가진 밥은 실제 코드를 구축하는 역할을 맡습니다. 밥에게는 다음과 같은 명확한 지침이 주어집니다.
...
**나. 리뷰 에이전트 '레이(Ray)'**
레이는 '보안에 집착하는 수석 소프트웨어 엔지니어(senior software engineer obsessed with security)' 역할을 수행합니다. 그의 주요 임무는 다음과 같습니다.
...
**다. 인간 에이전트 '댄(Dan)'**
댄 로스 본인은 이 시스템에서 "결정타를 날리는 사람(the person who breaks the tie)" 역할을 합니다. 밥이 무언가를 하려 하고 레이가 "안 된다"고 말할 때, 댄이 최종 결정을 내립니다. 그는 자신이 PM처럼 앱 전체를 머릿속에 넣고 우선순위를 정하는 데 능숙하지 않다고 인정합니다. 대신, 그는 "까다로운 고객"으로서 "무엇을 깊이 신경 쓰는가?"라는 질문에 답하며 개발 방향을 제시합니다.

**라. 기술적 구현 및 학습 철학**
로스는 클로드 웹 앱에 두 개의 별도 탭을 열어 밥과 레이를 각각 운영합니다. 각 에이전트에게는 맞춤형 프롬프트(prompt)를 통해 역할을 부여하고, 모든 작업 내용은 MD 파일로 기록합니다. 특히 주목할 점은 밥이 생성한 계획을 수동으로 복사하여 레이에게 붙여넣는 '의도적인 마찰(deliberate friction)'을 유지한다는 것입니다. 로스는 이를 통해 AI가 무엇에 어려움을 겪는지 직접 확인하고, 비기술적 배경을 가진 자신이 학습하는 데 도움을 받는다고 설명합니다.

### 3. 실제 워크플로우 들여다보기: 아이디어에서 앱스토어까지

[[SUM]] 아이디어를 클로드로 우선순위화한 후, 밥이 계획을 세우고 레이가 검토하며, 승인 후 밥이 코드를 생성하여 Xcode와 실제 기기에서 테스트한 뒤 앱스토어에 출시한다.

댄 로스의 개발 워크플로우는 아이디어 구상부터 앱스토어 출시까지 체계적으로 이루어집니다.

**가. 아이디어 관리 및 우선순위 지정**
로스는 클로드 채팅창을 '커뮤틀리(Commutely)' 앱의 기능 아이디어 및 추적기(tracker)로 활용합니다. 사용자 피드백을 바탕으로 새로운 아이디어를 입력하면, 클로드는 이를 구축 시간과 앱 성장에 미칠 잠재적 영향력(고객 만족도 및 성장 영향)이라는 1~3점 척도를 기준으로 순위를 매깁니다. 로스는 주말에 이 목록을 보고 몇 시간 안에 구축할 수 있는 기능을 선택하여 개발에 착수합니다.

**나. 계획 수립 및 검토**
선택된 기능에 대해 로스는 밥에게 개발을 지시합니다. 밥은 MD 파일로 기록된 기존의 리텐션(retention) 계획 등을 참조하여 상세한 구현 계획을 세웁니다. 이 계획이 완성되면, 로스는 이를 복사하여 레이에게 전달합니다. 레이는 해당 계획이 아키텍처적으로 올바른지, 보안상 문제는 없는지, 기존 디자인 가이드라인을 준수하는지 등을 검토합니다. 레이는 때로는 "엣지 케이스(edge case)" 우려를 제기하기도 하며, 밥의 계획이 타당하면 "녹색불(green light)"을 줍니다.

**다. 코드 생성 및 테스트**
레이의 승인이 떨어지면, 밥은 계획에 따라 코드를 생성하기 시작합니다. 이때 밥은 항상 새로운 브랜치(branch)에서 작업하도록 지시받습니다. 로스는 과거 메인(main) 브랜치에 직접 코드를 병합(merge)했다가 문제가 발생했던 경험을 통해 브랜치 사용의 중요성을 깨달았습니다.

생성된 코드는 Xcode로 가져와 시뮬레이터(simulator)와 실제 아이폰에서 테스트합니다. 로스는 Xcode의 기능을 5% 정도만 사용한다고 겸손하게 말하지만, 클로드에게 배운 기본적인 명령어(예: `Command Shift K`로 클린 빌드, `Control B`로 빌드)를 활용합니다. 그는 시뮬레이터 테스트만으로는 부족하며, 실제 기기에서 수많은 엣지 케이스를 발견한다고 강조합니다.

**라. 앱스토어 출시의 난관**
테스트가 완료되면 로스는 앱을 애플 앱스토어(App Store)에 배포합니다. 그는 개발 과정에서 가장 어려웠던 부분이 바로 앱스토어 탐색이었다고 고백합니다. 클로드를 통해 앱스토어 정책과 절차를 배우는 것이 "마지막 남은 마찰(last friction)"이라고 말할 정도입니다. 이에 그는 앱스토어 스크린샷 디자인을 자동화하는 AI 앱을 직접 만들고 싶다는 아이디어를 내기도 했습니다.

### 4. AI 시대의 '관리자' 역할: 인간 고유의 가치

[[SUM]] 로스는 AI를 '숙취에 시달리는 인턴'에 비유하며 컨텍스트를 상기시키고, '까다로운 고객'으로서 앱에 개성을 부여하며, AI 에이전트 계층 구조를 관리한다.

댄 로스는 AI 에이전트들을 관리하는 역할을 통해 인간 고유의 가치를 발휘합니다.

**가. '숙취에 시달리는 인턴' 비유**
로스는 AI를 "매우 똑똑하지만 숙취에 시달리는 인턴(really smart but hung over intern)"에 비유합니다. AI는 뛰어난 능력을 가졌지만, 이전의 컨텍스트나 제한 사항(예: iOS 라이브 액티비티의 기술적 한계)을 쉽게 잊어버리곤 합니다. 이때 로스는 "우리 전에 이거 얘기했잖아, 기억 안 나?"라고 상기시키며 AI를 올바른 방향으로 이끌어야 합니다. 이는 마치 유능하지만 경험이 부족한 주니어 인력을 관리하는 것과 유사합니다.

**나. 까다로운 고객으로서의 역할**
그는 자신이 품질 보증(QA) 담당자라기보다는 "샴페인을 마시기 전에 냄새를 맡는" 까다로운 고객이라고 말합니다. 앱의 작은 디테일이나 메시지의 톤(tone)까지 자신의 개성을 불어넣습니다. 예를 들어, 팟캐스트 클립 앱에서 영상 생성 중 오류 메시지를 "오 마이 갓, 당신은 팟캐스트의 멋진 부분을 클립했어요!"처럼 재미있게 바꾸도록 지시했습니다. 이는 인간만이 부여할 수 있는 '영혼'이자 '개성'입니다.

**다. 에이전트 계층 구조**
로스는 밥에게는 "서브 에이전트(sub-agents)를 생성할 수 있지만, 그 에이전트들에 대한 책임은 너에게 있다"고 지시합니다. 하지만 서브 에이전트들은 또 다른 서브 에이전트를 만들 수 없습니다. 반면 레이는 오직 하나의 "문지기(gatekeeper)"로서, 누구도 레이를 관리할 수 없고 레이 또한 서브 에이전트를 만들 수 없습니다. 이는 로스가 15년간 테크 회사에서 일하며 목격한 '수석 엔지니어(principal engineer)'와 같은 핵심 의사결정자의 역할을 AI 시스템에 반영한 것입니다.

### 5. 비코딩 업무에도 AI 활용: 일상 속 생산성 향상

[[SUM]] 로스는 400명 팀 관리 시 마이크로소프트 코파일럿을 활용, 퇴근 전 '제가 놓친 일은 무엇인가요?' 프롬프트로 놓친 업무를 파악하여 생산성을 높인다.
...
[[SUM]] 로스는 AI를 의인화하지 않고 명확히 지시하며, AI가 실수해도 '최고의 의도'를 가정하고 인내심을 가지고 올바른 방향으로 이끈다.
...
**[결론]**
댄 로스의 이야기는 AI 시대에 비기술적 배경을 가진 사람들도 충분히 혁신적인 빌더(builder)가 될 수 있음을 보여줍니다. '밥'과 '레이'라는 듀얼 AI 에이전트 시스템, '바이브 코딩' 철학, 그리고 AI를 효과적으로 관리하는 그의 노하우는 개발의 문턱을 낮추고 개인의 창의력을 극대화하는 새로운 가능성을 제시합니다. 그의 경험은 기술적 배경을 넘어 모든 이들에게 AI를 활용하여 자신만의 문제를 해결하고 세상을 변화시킬 수 있는 영감을 줍니다.
...
---
> **"A War Within the War: Israel’s Bombardment of Lebanon"** — **New York Times Podcasts** 기반 기사
> [원본 영상 보기](https://www.youtube.com/watch?v=wwty6NW9Gs0)
