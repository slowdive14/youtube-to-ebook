---
title: "YouTube Digest — 2026-04-02"
date: 2026-04-02
subject: "Robert Herjavec: The hidden reason smart people stop growing | Big Think+ & 4 more"
audioUrls:
  - "https://pub-627e42d23de845169be239bf2f1b52ad.r2.dev/audio/2026/04/02/Podcast_20260402_EN.m4a"
articles:
  - title: "Robert Herjavec: The hidden reason smart people stop growing | Big Think+"
    channel: "Big Think"
    url: "https://www.youtube.com/watch?v=kKqBidNBGRs"
  - title: "How Linear Turned AI Agents Into First-class Users"
    channel: "Every"
    url: "https://www.youtube.com/watch?v=8QcW9-dal0g"
  - title: "23 AI Trends keeping me up at night"
    channel: "Greg Isenberg"
    url: "https://www.youtube.com/watch?v=lyqk7zxbCKs"
  - title: "\"We're Not Writing Code by Hand Anymore. That's Over.\" | Owen Jennings & David Haber - The a16z Show"
    channel: "a16z"
    url: "https://www.youtube.com/watch?v=krdrkl38nRw"
  - title: "Today’s Mission to the Moon"
    channel: "New York Times Podcasts"
    url: "https://www.youtube.com/watch?v=CdYF4NpO3h0"
drillSentences:
  - sentence: "The quest for a mentor often feels like a non-negotiable step."
    korean: "멘토를 찾는 일은 종종 필수적인 단계처럼 느껴진다."
    blank: "The quest for a mentor often feels like a _____ step."
    blank_answer: "non-negotiable"
    swap_word: "step"
  - sentence: "many smart people unknowingly halt their own growth."
    korean: "많은 똑똑한 사람들이 자신도 모르게 성장을 멈춘다."
    blank: "many smart people unknowingly _____ their own growth."
    blank_answer: "halt"
    swap_word: "people"
  - sentence: "His insights challenge us to rethink how we seek guidance."
    korean: "그의 통찰력은 우리가 지도를 구하는 방식을 다시 생각하게 한다."
    blank: "His insights challenge us to rethink how we _____ guidance."
    blank_answer: "seek"
    swap_word: "guidance"
  - sentence: "The biggest misconception is the belief that a mentor must be a household name."
    korean: "가장 큰 오해는 멘토가 유명 인사여야 한다는 믿음이다."
    blank: "The biggest misconception is the belief that a mentor must be a _____."
    blank_answer: "household name"
    swap_word: "mentor"
  - sentence: "you need someone who possesses the specific knowledge or experience relevant to your current challenges."
    korean: "당신은 현재의 도전에 관련된 특정 지식이나 경험을 가진 사람이 필요하다."
    blank: "you need someone who possesses the specific knowledge or experience relevant to your current _____."
    blank_answer: "challenges"
    swap_word: "knowledge"
  - sentence: "Life is dynamic, and so too should be our sources of wisdom."
    korean: "삶은 역동적이며, 우리의 지혜의 원천 또한 그래야 한다."
    blank: "Life is dynamic, and so too should be our sources of _____."
    blank_answer: "wisdom"
    swap_word: "Life"
  - sentence: "Herjavec debunks the idea that mentorship is a static, enduring relationship."
    korean: "Herjavec은 멘토링이 정적이고 지속적인 관계라는 생각을 반박한다."
    blank: "Herjavec debunks the idea that mentorship is a static, _____ relationship."
    blank_answer: "enduring"
    swap_word: "mentorship"
  - sentence: "This fluidity means we should embrace different mentors for different phases and needs."
    korean: "이러한 유동성은 우리가 다른 단계와 필요에 따라 다른 멘토를 받아들여야 함을 의미한다."
    blank: "This fluidity means we should embrace different mentors for different _____ and needs."
    blank_answer: "phases"
    swap_word: "mentors"
  - sentence: "Mentorship is often a product of observation."
    korean: "멘토링은 종종 관찰의 산물이다."
    blank: "Mentorship is often a product of _____."
    blank_answer: "observation"
    swap_word: "product"
  - sentence: "This informal approach is more accessible than ever before."
    korean: "이러한 비공식적인 접근 방식은 그 어느 때보다 접근하기 쉽다."
    blank: "This informal approach is more _____ than ever before."
    blank_answer: "accessible"
    swap_word: "approach"
  - sentence: "Ego has killed more careers than anything else in the world."
    korean: "자만심은 세상의 어떤 것보다 많은 경력을 망쳤다."
    blank: "Ego has killed more careers than _____ else in the world."
    blank_answer: "anything"
    swap_word: "careers"
  - sentence: "The first key to it is being open to the idea that you may not have all the answers."
    korean: "그것의 첫 번째 핵심은 당신이 모든 답을 가지고 있지 않을 수도 있다는 생각에 열려 있는 것이다."
    blank: "The first key to it is being open to the idea that you may not have all the _____."
    blank_answer: "answers"
    swap_word: "idea"
  - sentence: "Confidence is a virtue, but arrogance is a barrier."
    korean: "자신감은 미덕이지만, 오만함은 장벽이다."
    blank: "Confidence is a virtue, but arrogance is a _____."
    blank_answer: "barrier"
    swap_word: "Confidence"
  - sentence: "If you believe the world has nothing left to teach you, you effectively shut yourself off from learning."
    korean: "세상이 당신에게 더 이상 가르칠 것이 없다고 믿는다면, 당신은 효과적으로 배움으로부터 자신을 차단하는 것이다."
    blank: "If you believe the world has nothing left to teach you, you effectively shut yourself off from _____."
    blank_answer: "learning"
    swap_word: "world"
  - sentence: "opportunities for learning and guidance become visible everywhere."
    korean: "배움과 지도를 위한 기회는 어디에서나 눈에 띄게 된다."
    blank: "opportunities for learning and guidance become visible _____."
    blank_answer: "everywhere"
    swap_word: "opportunities"
---

## English
> Based on **"Robert Herjavec: The hidden reason smart people stop growing | Big Think+"** from **Big Think**
> [Watch the original video](https://www.youtube.com/watch?v=kKqBidNBGRs)
...
[[SUM]] Herjavec argues against needing a celebrity mentor, stating that the role of a mentor is to teach specific, relevant knowledge, which can come from anyone, anywhere.
...
[[SUM]] Herjavec debunks the idea of mentorship as a static, lifelong relationship, emphasizing that mentors, like life, will change over time to suit different phases and needs.
...
[[SUM]] Mentorship often doesn't require formal agreements; Herjavec learned from figures like Warren Avis through observation and 'osmosis,' an informal approach more accessible today via resources like YouTube.
...
[[SUM]] The true 'hidden reason smart people stop growing' is ego, as humility and being open to not having all the answers are essential for continuous learning, even from unexpected sources like a janitor.
...
[[SUM]] The "red car theory" illustrates that opportunities for learning and mentorship become visible everywhere when one is consciously open and actively looking for them, and people are generally willing to help if asked.
...
[[SUM]] To master the mentor-mentee dynamic, mentees must respect the mentor's time, understand their preferred communication channels (like Mark Cuban's email preference), and comprehend their boundaries, such as Herjavec's preference for early morning contact over weekend calls.
...
---
> Based on **"How Linear Turned AI Agents Into First-class Users"** from **Every**
> [Watch the original video](https://www.youtube.com/watch?v=8QcW9-dal0g)
...
[[SUM]] Linear resisted the initial AI chatbot craze, instead spending years understanding potential AI workflows, leading to the insight that a multi-agent future required an open agent platform to guide and contextualize various external agents.
...
[[SUM]] Linear rejects "vanity metrics" like agent-written code percentage, focusing instead on classic metrics like profit and user love, and leveraging AI agents to enforce a strict "zero bugs" policy with a one-week SLA for fixes.
...
[[SUM]] Linear applies AI to accelerate execution after thoughtful problem-finding, using an internal "Linear Way skill" for product direction, AI for rapid design prototyping, and agents to instantly turn Slack conversations into actionable issues.
...
[[SUM]] Initially a hub for external AI agents, Linear shifted to developing its own "Linear Agent" to gain control, optimize end-to-end workflows, and create a deeper "product context or product memory platform," despite introducing token costs.
...
[[SUM]] Linear Agent demonstrates its capabilities through an "Understand Problem" skill that synthesizes complex feature requests and a coding agent that creates issues, spins up sandboxes, and writes code for review.
...
[[SUM]] Linear's AI journey highlights that core values like patience, quality, and understanding user needs remain paramount, ensuring that AI enhances human creativity to build the *right* things with clarity and commitment to quality.
...
---
> Based on **"23 AI Trends keeping me up at night"** from **Greg Isenberg**
> [Watch the original video](https://www.youtube.com/watch?v=lyqk7zxbCKs)
...
[[SUM]] Entrepreneurship is accelerating to hyper-speed, enabling ideas to become revenue-generating companies in hours, driven by powerful agent engineering platforms and leading to autonomous "ambient businesses" generating seven or eight figures with minimal human input.
...
[[SUM]] We are entering the "Agent Economy" (2025-2030) where AI agents discover and hire other agents, creating new marketplaces and necessitating a "Glassdoor of AI agents" to evaluate their efficacy, with 20% of commerce predicted to be agent-to-agent by 2030.
...
[[SUM]] Vertical AI presents a massive opportunity, predicted to yield over 300 unicorns, as it replaces human headcount in "boring goldmine verticals" like insurance and logistics, making its total addressable market significantly larger than Vertical SaaS.
...
[[SUM]] The industry is shifting from per-seat and usage-based models to "outcome-based" or "pay-per-result" pricing, with 40% of enterprise SaaS expected to adopt this by 2030, creating opportunities for new outcome-based startups.
...
[[SUM]] Generic SaaS tools will die, while creative judgment, human-made crafts, physical experiences, original thinking, and proprietary data will become scarce and premium, with "No AI Involved" labels signifying human quality.
...
[[SUM]] Founders will become "directors" orchestrating AI agents in a "ghost team org chart," enabling "micro-monopolies" where 100 true fans can sustain a profitable business with high margins and few employees.
...
[[SUM]] The rise of agents introduces a significant "agent attack surface" with risks like prompt injections and agent-to-agent manipulation, necessitating a new "agent permission stack" for cybersecurity.
...
[[SUM]] We are in an "asymmetric window" for builders, offering near-zero build costs, open niches, and underpriced audiences to create high-margin, compounding businesses, urging rapid building in public before the window narrows.
...
---
> Based on **""We're Not Writing Code by Hand Anymore. That's Over." | Owen Jennings & David Haber - The a16z Show"** from **a16z**
> [Watch the original video](https://www.youtube.com/watch?v=krdrkl38nRw)
...
[[SUM]] Block experienced a "binary change" in early December, breaking the correlation between headcount and output as one or two engineers became 10-100x more productive due to foundational models like Opus 46 and Codex 53, making manual coding "over."
...
[[SUM]] Block's over 40% workforce reduction was a strategic response to AI's dramatic productivity gains, disproportionately cutting development roles (engineering, product, design) rather than operational teams or sales, which saw "fairly de minimis" reductions.
...
[[SUM]] Block executed the reduction with principles of reliability, customer trust, and durable growth, offering generous severance and maintaining transparency; culturally, it led to a 70-80% reduction in meetings and a focus on building within a "smaller, leaner" company.
...
[[SUM]] Block's AI engine includes Goose, a model-agnostic "agent harness"; G2, an internal "agentic operating system" for automating deterministic workflows; and Builderbot, which autonomously merges PRs and builds features to 85-90% completion.
...
[[SUM]] The new structure features small squads of 1-6 people, a 50-60% reduction in layers, and a non-linear workflow where humans manage "14 agents who are building PRs" and oversee "countless agents running right now" across various functions.
...
[[SUM]] Block is leveraging its agentic infrastructure to create dynamic, personalized "Generative UI" for products like Cash App's Moneybot and Square's ManagerBot, where interfaces and features are generated on-the-fly based on user queries, offering "way more control" and "higher engagement."
...
[[SUM]] In the long term, Block believes defensibility will be "the extent to which the company understands something that is pretty hard for other companies to understand," building "world models" and iterating at unprecedented speeds with AI tools, warning that companies without deep understanding "could get vibe coded away."
...
[[SUM]] Block's transformation suggests AI will lead to a "superset of things that can be built," potentially expanding tech into new sectors, with companies that embrace intelligent systems leading the next era of innovation by orchestrating intelligence rather than writing code by hand.
...
---
> Based on **"Today’s Mission to the Moon"** from **New York Times Podcasts**
> [Watch the original video](https://www.youtube.com/watch?v=CdYF4NpO3h0)
...
[[SUM]] NASA's Artemis program aims to establish a permanent lunar base for scientific research, commercial Helium-3 mining, and as a testing ground for Mars missions, driven by a geopolitical race with China to set future space commerce rules.
...
[[SUM]] Commander Reid Wiseman, Victor Glover, Christina Koch, and Canadian Jeremy Hansen will embark on a 10-day Artemis 2 mission to test life support systems, culminating in a lunar flyby around the moon's far side before returning to Earth.
...
[[SUM]] Artemis 2 is NASA's last major independent mission, as future endeavors like Artemis 3 will integrate private companies like SpaceX and Blue Origin for lunar landers, marking a shift towards collaborative space exploration.
...
[[SUM]] Similar to Apollo 8's message of unity during 1968, Artemis 2's imagery of Earth from space has the potential to offer a calming perspective and a reminder of our shared humanity amidst global turbulence.
...
## 한국어
> **"Robert Herjavec: The hidden reason smart people stop growing | Big Think+"** — **Big Think** 기반 기사
> [원본 영상 보기](https://www.youtube.com/watch?v=kKqBidNBGRs)
...
[[SUM]] 멘토는 유명인일 필요 없고, 멘토십은 영원불멸하지 않으며, 공식적인 계약 관계가 아닌 간접 학습으로도 가능하다는 세 가지 오해가 성장을 방해한다.

허재벡은 사람들이 멘토십에 대해 가지고 있는 세 가지 큰 오해를 꼬집습니다. 이러한 오해는 우리가 진정한 성장의 기회를 놓치게 만드는 주된 원인이 됩니다.

**1. 멘토는 유명인이어야 한다는 환상**
"로버트, 제 멘토가 되어줄 수 있나요?" 허재벡이 가장 많이 받는 질문 중 하나입니다. 그의 대답은 단호하게 "아니요, 저는 너무 바쁩니다"입니다. 그는 멘토십에 대한 가장 큰 오해가 "샤크 탱크"에 나오는 유명인이나 모두가 아는 리더가 멘토가 되어야 한다고 생각하는 것이라고 말합니다. 하지만 멘토의 진정한 역할은 현재 당신의 경력에 도움이 될 무언가를 가르쳐주는 것입니다. 배움은 누구에게서든 얻을 수 있으며, 유명세와는 상관없습니다.

**2. 멘토십은 영원불멸하다는 믿음**
멘토십이 평생 지속되는 불변의 관계라는 생각은 사실이 아닙니다. 23세에 조직에 처음 발을 들였을 때 필요한 조언과 45세에 고위 부사장(Senior Vice President)이 되었을 때 필요한 조언은 완전히 다릅니다. 당신의 삶이 시간이 지남에 따라 변하듯이, 당신의 멘토 또한 필요에 따라 자연스럽게 변화해야 합니다. 한 명의 멘토가 당신의 모든 성장 단계를 책임질 수는 없습니다.

**3. 멘토십은 공식적인 계약 관계라는 착각**
많은 사람이 멘토십을 어떤 보이지 않는 계약을 맺는 것과 같은 공식적인 과정으로 여깁니다. 하지만 허재벡은 자신의 인생에서 가장 큰 멘토 중 일부는 자신이 멘토였다는 사실조차 몰랐다고 말합니다. 에이비스 렌터카(Avis Rent A Car)를 창업한 워렌 에이비스(Warren Avis)가 대표적인 예입니다. 허재벡은 그에게서 많은 것을 배웠지만, 에이비스는 자신이 멘토 역할을 했다는 것을 알지 못했을 것이라고 합니다. 멘토십은 때로는 그저 지켜보고, 배우고, 자연스럽게 흡수하는 간접 학습(osmosis)을 통해 이루어지기도 합니다. 특히 오늘날 유튜브와 같은 온라인 플랫폼에서는 수많은 정보를 통해 간접적으로도 충분히 배울 수 있습니다.

### 진정한 학습과 멘토를 찾는 핵심

[[SUM]] 자만심을 버리고 겸손한 자세로 누구에게서든 배울 준비를 하며, '빨간 차 이론'처럼 기회를 인식하고, 필요할 때 도움을 청하는 용기가 진정한 학습의 핵심이다.

그렇다면 어떻게 해야 진정으로 배우고 성장하며, 자신에게 맞는 멘토를 찾을 수 있을까요? 허재벡은 세 가지 핵심 요소를 강조합니다.

**1. 성장을 위한 첫걸음: 열린 마음과 겸손**
허재벡은 "자만심(ego)은 세상의 어떤 것보다 많은 경력을 망쳤습니다"라고 단언합니다. 당신이 아무리 뛰어나고 당신의 아이디어가 아무리 훌륭해도, 약간의 겸손은 반드시 필요합니다. 모든 답을 가지고 있지 않을 수도 있다는 가능성에 마음을 여는 것이 중요합니다. 자신감(confidence)은 훌륭하지만, 오만함(arrogance)은 나쁩니다. 세상이 당신에게 가르쳐줄 것이 아무것도 없다고 느낀다면, 당신은 세상으로부터 아무것도 배울 수 없습니다. 멘토십은 결국 끊임없이 배우는 삶의 자세이며, 당신은 누구에게서든 배울 수 있습니다. 허재벡은 심지어 한 청소부에게서 놀라운 근면함과 완벽주의에 대한 광적인 집착, 그리고 끊임없는 개선 의지를 배운 적이 있다고 고백합니다. 배움은 당신 주변 어디에나 있습니다.

**2. 기회를 포착하는 '빨간 차 이론'**
허재벡의 멘토 중 한 명이 그에게 '빨간 차 이론'을 들려주었습니다. 오늘 출근길에 빨간 차를 몇 대 봤는지 묻는다면, 아마 정확히 대답하지 못할 것입니다. "몇 대 본 것 같긴 한데…" 정도겠죠. 하지만 내일 출근길에 빨간 차 수를 세어보라고 한다면, 당신은 분명 그렇게 할 것입니다. 기회와 멘토십도 이와 같습니다. 당신이 마음을 열고 주의를 기울이면, 그것들은 당신 주변에 늘 존재합니다. 핵심은 '인식'입니다. 주변에 얼마나 많은 빨간 차가 있는지 알기 위해서는 먼저 빨간 차를 의식하고 찾아야 합니다.

**3. 도움을 청하는 용기**
허재벡은 자신의 경험상, 물론 세상에는 타인에게 불친절한 사람들도 존재하지만, 대다수(98%)의 사람들은 매우 친절하다고 말합니다. 그리고 당신이 도움을 요청하면, 대부분의 경우 사람들은 기꺼이 당신을 도울 것입니다. 그러니 도움을 청하는 것을 결코 두려워하지 마세요.

### 성공적인 멘토-멘티 관계를 위한 현명한 접근법

[[SUM]] 멘토의 시간을 존중하고, 마크 큐반처럼 멘토의 소통 방식을 이해하며 맞춰야 하며, 멘토의 개인적인 경계를 명확히 이해하고 존중하는 것이 관계 유지에 필수적이다.

마지막으로, 허재벡은 멘토와 멘티(mentee) 관계를 성공적으로 이끌기 위한 실질적인 조언을 전합니다.

**1. 시간 존중: 멘토의 가장 소중한 자산**
멘토와의 관계에서 가장 중요한 것은 시간을 존중하는 것입니다. 허재벡은 "저는 매우 바쁜 사람입니다. 그리고 자유 시간이 있다면 아이들과 시간을 보내고 싶지, 아마 당신과 시간을 보내고 싶지는 않을 겁니다"라고 솔직하게 말합니다. 멘토의 시간을 존중하는 것은 기본 중의 기본입니다.

**2. 현명한 소통 방식: 마크 큐반의 예시**
올바른 질문을 올바른 시기에 하는 것만큼이나 중요한 것이 올바른 소통 방식을 찾는 것입니다. 그는 마크 큐반(Mark Cuban)의 예를 듭니다. 큐반은 전화 통화를 극도로 싫어하지만, 밤 10시 30분에 이메일을 보내면 3분 안에 답장을 받을 수 있습니다. 허재벡 자신도 마찬가지입니다. 그는 전화 통화가 하루의 흐름을 방해하기 때문에 싫어하지만, 이메일은 자신의 일정에 맞춰 적절한 시간에 답장할 수 있습니다. 허재벡은 매일 아침 5시에 일어나는데, 오전 5시부터 9시 사이에 이메일을 확인합니다. 이때 연락하는 것이 그에게는 가장 좋은 시간입니다. 멘티인 당신이 멘토의 작업 방식을 이해하고 그에 맞춰 소통해야 최대한의 도움을 받을 수 있습니다.

**3. 명확한 경계 설정: 일과 삶의 균형**
직장에서 "우리는 한 가족"이라는 말을 자주 듣지만, 허재벡은 현실은 그렇지 않다고 말합니다. 그의 회사는 사업이었고, 그의 가족은 그의 가족이었습니다. 그는 밤이나 특정 시간에 가족에게서 시간을 빼앗으려는 시도에 불편함을 느꼈다고 합니다. 모든 사람은 다르므로, 멘토의 경계를 명확히 이해해야 합니다. 어떤 사람들은 주말에도 연락하는 것을 좋아하지만, 허재벡은 그렇지 않습니다. 멘토의 개인적인 공간과 시간을 존중하는 것이 관계 유지에 필수적입니다.
...
---
> **"How Linear Turned AI Agents Into First-class Users"** — **Every** 기반 기사
> [원본 영상 보기](https://www.youtube.com/watch?v=8QcW9-dal0g)
...
[[SUM]] Linear는 AI 시대에 SaaS 기업들이 단순한 챗봇 추가를 넘어, '데이 원의 세계'에 살며 매일 제품을 재구상해야 한다고 주장하며, 대기업보다 스타트업이 이러한 변화에 더 잘 대응할 수 있다고 강조한다.
...
[[SUM]] Linear는 GPT-3 출시 당시 서두르지 않고 AI의 실제 유용성을 이해하는 데 집중했으며, 개방형 에이전트 플랫폼을 구축해 다른 에이전트들이 Linear와 쉽게 통합되도록 유도하며 '가이드 시스템' 역할을 했다.
...
[[SUM]] 외부 에이전트 통합의 한계를 극복하고자 Linear는 자체 'Linear Agent'를 개발, 제품 기획부터 디자인, 엔지니어링까지 엔드투엔드 경험을 제공하며, 특히 '맥락' 관리를 효율화하여 토큰 사용량 기반 과금 모델을 고려하고 있다.
...
[[SUM]] Linear는 AI를 통해 버그 수정 루프를 단축하고, PM은 'Linear 제품 팀원처럼 행동하는' 개인 스킬로 문제의 본질을 빠르게 파악하며, 디자인 및 엔지니어링 팀은 프로토타입 구축과 슬랙 에이전트 활용으로 작업 속도를 높인다.

Linear는 AI 에이전트를 외부 고객뿐만 아니라, 내부 팀의 업무 방식 혁신에도 적극적으로 활용하고 있습니다.

**1. 팀 문화와 성과 측정:**
초기에는 팀원들이 새로운 AI 도구를 사용하는 데 익숙해지도록 장려하는 시간이 필요했습니다. 하지만 이제는 대부분의 엔지니어와 일부 디자이너, PM들이 에이전트 코딩 도구를 사용합니다. 카리는 여기서 중요한 점은 '어떤 지표를 측정하는가'라고 강조합니다. "사람들이 이제 '코드의 몇 퍼센트가 에이전트가 작성한 것인가', '얼마나 많은 PR(Pull Request)을 병합했는가'를 최고의 허영 지표(vanity metric)로 삼습니다. 하지만 이는 올바른 지표가 아닙니다."
...
**2. 제품 기획(PM) 워크플로우:**
카리는 개인적으로 Linear Agent의 '스킬(Skill)' 기능을 활용하여 제품 기획 프로세스를 혁신하고 있습니다. 그는 Linear의 내부 문서와 블로그 게시물을 학습시켜 'Linear 제품 팀원처럼 행동하며 문제의 근본적인 필요를 이해하고 솔루션을 제안하는' 개인 스킬을 만들었습니다.
...
**3. 디자인 및 엔지니어링 워크플로우:**
카리는 개인적으로는 여전히 피그마(Figma)에서 수동으로 디자인하며 '느림의 미학'을 통해 깊이 있는 탐색을 즐긴다고 말합니다. 하지만 디자인 팀 전체적으로는 AI를 활용하여 더 많은 프로토타입을 빠르게 구축하고 테스트하는 데 주력하고 있습니다. Linear는 강력한 빌드 시스템을 갖추고 있어, 프로토타입을 직접 앱에 통합하여 실시간으로 테스트할 수 있습니다.
...
[[SUM]] 카리는 AI가 작업 속도를 가속화하지만, '문제 발견'은 신중하게 시간을 투자하고 '문제 해결'은 빠르게 진행해야 한다고 강조하며, 베타 테스트 목표도 '이해'에 두어야 한다고 말한다.
...
[[SUM]] Linear의 사례는 AI 시대 성공이 기술 도입을 넘어 제품 가치와 사용자 워크플로우에 대한 깊은 이해, 그리고 품질 추구에 있음을 보여주며, AI는 인간의 '장인정신'을 돕는 '일등 시민'으로서 혁신을 이끈다.

Linear의 사례는 AI 시대의 성공이 단순히 최신 기술을 도입하는 것을 넘어선다는 것을 명확히 보여줍니다. 이는 **제품의 본질적인 가치와 사용자 워크플로우에 대한 깊은 이해, 그리고 장기적인 관점에서 품질을 추구하는 인내심**에 달려 있습니다.
...
---
> **"23 AI Trends keeping me up at night"** — **Greg Isenberg** 기반 기사
> [원본 영상 보기](https://www.youtube.com/watch?v=lyqk7zxbCKs)
...
[[SUM]] AI 덕분에 '1시간 기업 스택'으로 비즈니스 구축이 몇 시간 안에 가능하며, AI 에이전트가 자율적으로 운영하는 '앰비언트 비즈니스'가 연간 7~8자릿수 수익을 창출할 것입니다.
...
나아가 아이젠버그는 **'앰비언트 비즈니스(Ambient Business)'** 또는 **'자율 비즈니스(Autonomous Business)'**의 등장을 예고합니다. 이는 인간의 개입이 거의 또는 전혀 없이 운영되는 사업 모델을 의미합니다. AI 에이전트들이 시장을 모니터링하고, 기회를 식별하며, 스스로 실행하고, 고객 서비스를 처리하는 등 사업의 거의 모든 측면을 자율적으로 관리합니다. 창업자는 며칠에 한 번씩 사업을 확인하는 정도로 충분하며, 이러한 자율 비즈니스가 연간 7~8자릿수(수백억~수천억 원)의 수익을 창출할 수 있는 시대가 올 것이라고 전망합니다. 현재는 초기 단계이며 'AI 슬롭(AI Slop)'이라 불리는 저품질 결과물을 내는 경우가 많지만, 진보의 화살표는 명확히 이 방향을 향하고 있습니다.

### II. 에이전트 경제의 도래: '에이전트 to 에이전트' 비즈니스

[[SUM]] 2025-2030년 '에이전트 경제'에서는 AI 에이전트들이 서로를 고용해 작업을 수행하며, 2030년까지 상거래의 20%가 '기계 대 기계' 방식으로 이루어질 것입니다.
...
[[SUM]] YC는 향후 10년 내 300개 이상의 버티컬 AI 유니콘을 예측하며, 버티컬 AI는 인건비 대체로 TAM을 10배 확장, 보험·법률 등 구식 산업의 '서브 니치'가 기회입니다.

YC(Y Combinator)는 향후 10년 동안 버티컬 AI(Vertical AI) 분야에서 300개 이상의 유니콘 기업이 탄생할 것이라고 예측했습니다. 이는 특정 산업이나 틈새시장에 특화된 AI 솔루션을 의미합니다. 과거 컨스텔레이션 소프트웨어(Constellation Software)가 다양한 버티컬(Vertical) 산업에서 수백 개의 SaaS(Software as a Service) 기업을 인수한 것처럼, 이제는 **버티컬 AI 컨스텔레이션 소프트웨어**를 구축할 기회가 왔습니다.
...
[[SUM]] 2030년까지 기업용 SaaS의 40%가 '결과 기반' 가격 모델로 전환될 것이며, 범용 CRM, 기본 분석 대시보드 등은 'SaaS의 무덤'으로 사라질 것입니다.
...
[[SUM]] AI가 코드, 콘텐츠 등을 상품화하면서 '창의적 판단', '인간이 만든 공예품', '독창적인 기이한 사고', '독점 데이터'가 희소하고 프리미엄 가치를 가질 것입니다.
...
[[SUM]] AI 시대에는 창업가가 에이전트를 잘 조율하는 '파운더-에이전트 적합성'이 중요하며, 미래 기업은 몇 명의 인간과 수많은 AI 에이전트로 구성된 '고스트 팀'을 가질 것입니다.
...
아이젠버그는 이를 **영화감독**에 비유합니다. 영화감독은 카메라를 들거나 직접 연기하거나 음악을 작곡하지 않습니다. 대신 배우들로부터 최고의 연기를 이끌어냅니다. 이제 그 '배우'의 역할이 사람에서 기계(에이전트)로 바뀌는 것입니다. 특정 니치(Niche)에서 에이전트를 구축하고, 관리하며, 최대한의 성과를 이끌어내는 능력은 창업가에게 비대칭적인 우위(Unfair Advantage)를 제공할 것입니다.
...
[[SUM]] AI 에이전트가 운영 비용을 극적으로 절감하여, 케빈 켈리의 '1000명의 진정한 팬' 개념이 '100명의 진정한 팬'으로 축소되어도 충분히 사업을 유지할 수 있습니다.
...
---
> **""We're Not Writing Code by Hand Anymore. That's Over." | Owen Jennings & David Haber - The a16z Show"** — **a16z** 기반 기사
> [원본 영상 보기](https://www.youtube.com/watch?v=krdrkl38nRw)
...
[[SUM]] 블록의 40% 인력 감축은 잭 도시 CEO의 선견지명과 '오푸스 46', '코덱스 53' 같은 AI 도구의 발전으로 생산성 관계가 근본적으로 깨진 '이진적 변화'의 결과이며, 개발 부문에서 가장 큰 감축이 이루어졌다.
...
[[SUM]] 블록은 안정성, 고객 신뢰, 지속 가능한 성장을 원칙으로 조직을 '제로 베이스'에서 재구축했고, 회의 70~80% 감소 및 소통 강화로 '빌딩'에 집중하는 작고 효율적인 조직으로 변화했다.
...
인력 감축 이후 블록의 업무 방식은 극적으로 변화했습니다. 회의는 70~80%가량 줄어들어 직원들이 '빌딩(building)'에 집중할 시간을 확보했습니다. 또한, 잭 도시를 비롯한 경영진과 매주 1~2시간의 전사 회의를 통해 소통을 강화했습니다. 제닝스는 "더 작고, 더 효율적이며, 계층이 적고, 더 넓은 관리 범위를 갖게 되었다"며, "다시 빌딩에 집중하는 분위기"라고 전했습니다. AI는 단순히 도구가 아니라 조직의 변화를 강제하는 '강제 기능(forcing function)'으로 작용하며, 선형적인 워크플로우에서 벗어나 여러 AI 에이전트를 관리하는 방식으로 업무가 진화하고 있음을 보여줍니다.

### AI 기반 인프라와 제품의 혁신

[[SUM]] '구스' 에이전트 인프라와 '빌더봇'으로 개발을 자동화하고, 조직 계층을 50~60% 줄여 소규모 스쿼드 중심으로 재편했으며, 캐시 앱의 '머니봇'과 생성형 UI를 통해 개인화된 동적 사용자 경험을 제공한다.
...
*   **조직 구조 개편:** 기존의 계층적, 기능별 구조에서 벗어나 계층을 50~60% 줄이고, 1~6명으로 구성된 소규모 스쿼드(squad) 중심으로 유연하게 운영됩니다. 이는 정보 흐름을 원활하게 하고, 팀들이 여러 제품에 유연하게 기여할 수 있도록 합니다.
*   **개발 외 영역 자동화:** 고객 지원 챗봇, AI 전화 지원은 문의의 대부분을 자동 처리하며, 제품 운영, 리스크 운영, 규제 준수 운영 등 결정론적 워크플로우 전반에 걸쳐 AI가 인간보다 더 나은 결정을 내릴 수 있음을 보여줍니다. 현재는 '인간 개입(Human-in-the-loop)'이 중요하지만, 장기적으로는 시스템이 인간보다 훨씬 뛰어날 것이라는 전망입니다.

**제품 혁신과 생성형 UI:**
블록은 과거 사업부 중심(스퀘어, 캐시 앱, 애프터페이 각각 별도 CEO)에서 벗어나, 18개월 전부터 엔지니어링, 디자인, 제품 등 핵심 기능을 통합하는 '기능별 조직(functionalized company)'으로 전환했습니다. 이는 브랜드에 구애받지 않는 기술 인프라를 구축하고, 스퀘어, 캐시 앱, 애프터페이 전반을 연결하는 생태계 전략의 일환입니다.
...
[[SUM]] 블록의 단기 해자는 유통, 규제, 하드웨어이며, 장기적으로는 '이해하기 매우 어려운 무언가를 이해하는 능력'과 지능형 시스템으로 진화하는 것이며, AI는 엔지니어 수를 줄이기보다 새로운 가능성을 열 것이다.
...
[[SUM]] 블록의 40% 인력 감축은 AI가 기업의 존재 방식을 재정의하는 시대의 선제적 변화이며, 미래 기업의 성공은 AI를 활용해 심층적으로 '이해'하고 혁신하는 능력에 달려 있다.
...
---
> **"Today’s Mission to the Moon"** — **New York Times Podcasts** 기반 기사
> [원본 영상 보기](https://www.youtube.com/watch?v=CdYF4NpO3h0)
...
[[SUM]] 아르테미스 프로그램은 달에 영구 거주지를 건설하고 화성 탐사 전초 기지로 활용하는 목표를 가집니다. 아르테미스 2호는 유인 비행으로 생명 유지 시스템을 시험하며, 3호는 달 표면 착륙을 목표로 합니다.
...
[[SUM]] 아르테미스 2호는 리드 와이즈먼, 빅터 글로버, 크리스티나 코크, 제레미 핸슨 4명의 우주 비행사가 탑승해 10일간 달 궤도를 선회합니다. 이들은 달의 뒷면을 관측하고 지구로 귀환합니다.
...
[[SUM]] 아르테미스 프로그램은 달을 과학 연구 기지, 헬륨-3 자원 채굴지, 심우주 관측소, 화성 탐사 시험장으로 활용하며, 인류의 다행성 종족화와 중국과의 지정학적 경쟁에도 기여합니다.

아르테미스 프로그램은 단순한 달 탐사를 넘어 인류의 미래에 대한 거대한 비전을 제시합니다.

1.  **과학 연구 기지:** 달 기지는 처음에는 남극의 연구 기지처럼 과학자들이 달에 장기 체류하며 심도 있는 연구를 수행하는 장소가 될 것입니다.
2.  **자원 채굴:** 달 자원의 활용 가능성에 대한 논의도 활발합니다. 특히 '헬륨-3(Helium-3)'는 지구에서는 매우 희귀하지만 달 표면에 상대적으로 풍부하게 존재합니다. 헬륨-3는 미래 핵융합 발전(fusion reactors)의 핵심 연료로 활용될 수 있으며, 양자 컴퓨터(quantum computers)나 인공지능(AI) 기술 개발에도 유용할 것으로 기대됩니다. 현재 지구에서 헬륨-3 1파운드(약 450g)는 약 3백만 달러에 달하는 가치를 가지고 있어, 달에서 소량만 채굴해도 상당한 수익을 창출할 수 있습니다.
3.  **심우주 관측소:** 달의 뒷면에는 지구의 TV, 휴대폰, 팟캐스트 등 온갖 전파 소음이 차단된 '죽은 듯이 고요한' 환경이 존재합니다. 이곳에 거대한 전파 망원경을 건설하면, 수십억 년 전 빅뱅(Big Bang) 직후의 미세한 우주 신호를 포착하여 우주의 기원을 연구하는 데 획기적인 도움이 될 수 있습니다. 이는 사실상 '태초의 소리'를 듣는 것과 같은 경험이 될 것입니다.
4.  **화성 탐사 시험장:** 달은 화성 탐사를 위한 기술 시험장으로도 활용될 것입니다. 달의 환경과 중력은 화성과 유사한 점이 많으므로, 핵 발전소, 거주지, 생명 유지 시스템 등 화성에서 필요한 기술들이 달에서 먼저 테스트될 것입니다.
5.  **다행성 종족의 꿈:** 인류가 하나의 행성에만 국한되지 않고 우주로 뻗어나가는 '다행성 종족(multi-planet species)'이 되겠다는 낭만적인 비전도 있습니다. 언젠가 달에 인류의 식민지가 건설될 수도 있습니다.
6.  **지정학적 경쟁:** 이 모든 비전 뒤에는 중국과의 지정학적 경쟁이라는 현실적인 동기도 있습니다. 먼저 달에 도착하여 거점을 확보하는 국가가 우주 상거래 규칙을 정하고 핵심 자원을 통제할 수 있는 주도권을 쥐게 될 것이기 때문입니다.

### 옛 방식의 승리, 그리고 새로운 시대의 도래

[[SUM]] 아르테미스 2호는 NASA 주도의 '올드 스쿨' 방식의 마지막 대규모 임무가 될 것입니다. 아르테미스 3호부터는 스페이스X, 블루 오리진 등 민간 기업이 달 착륙선 개발에 참여하며 새로운 우주 시대가 열립니다.
...
[[SUM]] 아르테미스 2호 임무는 혼란스러운 시대에 인류를 통합하고 희망을 주는 메시지가 될 수 있습니다. 달에서 본 지구는 우리가 모두 같은 행성의 일부임을 일깨우는 강력한 이미지를 제공할 것입니다.
