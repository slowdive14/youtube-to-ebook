...
speakingPrompt:
  topic: "Learning new tech"
  question_ko: "새로운 기술을 배우면서 예전에는 어떻게 했었는데, 이제는 그래서 어떻게 하는지 이야기해 줄 수 있나요?"
  frame: "When I learn new tech, I used to ___, that's why I ___ now."
  model: "When I learn new tech, I used to read many books, that's why I watch videos now."
  patterns:
    - pattern: "I used to ___."
      pattern_ko: "나는 예전에 ___하곤 했어."
      s1_en: "I used to play games all night."
      s1_ko: "나는 예전에 밤새 게임을 하곤 했어."
      s2_en: "I used to send many emails."
      s2_ko: "나는 예전에 이메일을 많이 보내곤 했어."
      s2_answer: "send many emails"
    - pattern: "That's why I ___."
      pattern_ko: "그래서 나는 ___."
      s1_en: "It was difficult, that's why I gave up."
      s1_ko: "그것은 어려웠고, 그래서 나는 포기했어."
      s2_en: "I was tired, that's why I went home."
      s2_ko: "나는 피곤했고, 그래서 나는 집에 갔어."
      s2_answer: "went home"
---
