...
speakingPrompt:
  topic: "AI Teammates"
  question_ko: "AI를 '팀원'으로 생각하는 것에 대해 어떻게 생각하세요?"
  frame: "AI as a teammate ___ very helpful, but it also ___ some challenges."
  model: "AI as a teammate could be very helpful for complex tasks, but it also brings some challenges like trusting its autonomy."
  patterns:
    - pattern: "It would have taken ___ to finish."
      pattern_ko: "끝내려면 ___ 걸렸을 거예요."
      s1_en: "It would have taken five days to finish."
      s1_ko: "그것을 끝내려면 5일이 걸렸을 거예요."
      s2_en: "It would have taken all night to finish."
      s2_ko: "그것을 끝내려면 밤새 걸렸을 거예요."
      s2_answer: "all night"
    - pattern: "I used to ___ before."
      pattern_ko: "전에는 ___ 했었어요."
      s1_en: "I used to use simpler models before."
      s1_ko: "전에는 더 간단한 모델을 사용했었어요."
      s2_en: "I used to do everything manually before."
      s2_ko: "전에는 모든 것을 수동으로 했었어요."
      s2_answer: "do everything manually"
---
