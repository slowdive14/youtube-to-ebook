...
[[SUM]] GitHub now sees a significant influx of "knowledge workers" from non-traditional tech backgrounds using AI tools like GitHub Copilot to build apps, expanding the definition of a developer and shaping the product roadmap for inclusivity.
...
[[SUM]] To address the overwhelming volume of AI-generated code, GitHub is developing agentic tools like Copilot Code Review and "agentic merge" to streamline processes, while providing maintainers granular control to self-organize rather than imposing universal standards.
...
[[SUM]] AI agents are driving an exponential surge in activity, with 17 million pull requests created by agents in March alone, signaling a fundamental shift where developers collaborate with AI partners to generate code at an unprecedented pace.
...
[[SUM]] The rise of 24/7 AI agents challenges traditional freemium models, with GitHub exploring usage-based pricing for scaled agent activity while ensuring a great core experience and balancing API rate limits for individual developers and enterprises.
...
[[SUM]] Kyle Dagel's dual role as COO of GitHub and CMO of Developer for Microsoft ensures an unwavering developer-centric focus, extending GitHub's philosophy across Microsoft's tooling to create authentic, holistic solutions and foster community-led innovation.
...
[[SUM]] GitHub differentiates itself by committing to "developer choice," actively resisting walled gardens by partnering with and integrating capabilities from various AI model providers like Anthropic, OpenAI, and Google through GitHub Copilot.
...
[[SUM]] GitHub's internal decision-making uses "hill climbing," an iterative, data-driven approach based on hard metrics and user sentiment, to continuously improve models and tools with small, consistent changes rather than chasing moonshots.
...
[[SUM]] To prevent spiraling agent costs, GitHub is developing "model routers" that intelligently select the most cost-effective AI model for specific tasks, combined with "Frontier Tuning" for personalization, optimizing token usage for enterprises.
...
[[SUM]] Kyle Dagel uses a personal AI, "Baxter," to review his communications and provide critical feedback, highlighting how agents can augment human skills and offer a less threatening, recursive self-improvement loop for communication.
...
[[SUM]] GitHub, under Kyle Dagel, is shaping the AI revolution with an inclusive, developer-first approach, offering choice, fostering community innovation, and embracing iterative improvement to ensure the future of code is collaborative and efficient.
...
[[SUM]] The AI-generated song "Phenomenal Black Woman" became a viral sensation, yet its "on the nose" and "caricature turned up to 11" quality, designed to elicit a strong emotional response, revealed its inauthentic nature despite resonating with many Black women due to a lack of genuine media representation.
...
[[SUM]] Beyond the ethically dubious song, AI-generated content is used for more harmful exploitation, ranging from low-level scams to deeply nefarious forms of manipulation.
...
[[SUM]] One prevalent scam involves AI-generated videos of Black children supposedly making handmade items with tragic backstories, preying on community solidarity to sell mass-produced, drop-shipped goods from unethical sources.
...
[[SUM]] AI is also a potent tool for political manipulation, creating "political oppo videos" and "racist fanfiction" like AI-generated videos of "racially stereotypical black women" having "big reactions" in grocery stores, designed to validate pre-existing biases and spread misinformation.
...
[[SUM]] The use of AI to create racially charged caricatures is termed "digital blackface," where AI-generated Black women are depicted saying "racially degrading or racially inflammatory things" to drive engagement, dropshipping scams, or direct to paid adult content sites, exploiting stereotypes for profit.
...
[[SUM]] AI exploitation thrives due to its low cost, ease of production, and platforms' financial incentives for viral content, allowing for the commodification of Blackness and other identities without compensating actual people or addressing racist depictions.
...
[[SUM]] The "girlbossification of AI," exemplified by Reese Witherspoon, pushes women into AI, despite women's skepticism stemming from environmental concerns, increased scrutiny on marginalized identities, and the added burden of learning complex technology amidst existing emotional labor.
...
[[SUM]] The publishing industry faces AI disruption, as seen in the 2024 "Goodreads scandal" and the cancellation of Mia Ballard's *Shy Girl*, highlighting publishers' desire to use AI without clear policies, leaving authors vulnerable to backlash.
...
[[SUM]] While individual mindfulness—questioning strong emotional reactions to content—is a starting point, the burden shouldn't solely fall on users; systemic solutions and greater accountability from platforms and AI developers are profoundly needed to combat AI's amplification of societal problems.
...
[[SUM]] Julian BraveNoiseCat and his father, Ed Archie NoiseCat, bonded through smoking weed and playing "Bong Hit Scrabble," but Julian also carried deep wounds from his father's absence during his childhood.
...
[[SUM]] Julian's childhood was marked by his father's sporadic presence and self-destructive tendencies, leading Julian to fear repeating his father's mistakes and confront him at age 16 about the abandonment.
...
[[SUM]] At 28, Julian moved back in with his father and discovered the shocking truth of his father's birth at St. Joseph's Mission, found in a trash incinerator, revealing the intergenerational trauma of residential schools that explained his father's struggles.
...
[[SUM]] Julian connected his father's complex personality—charismatic, resilient, flawed—to the Indigenous trickster coyote figure, providing a cultural lens to understand his father and reclaim lost heritage.
...
[[SUM]] After reading Julian's book, his father apologized, and now Julian, on the cusp of fatherhood, hopes to break cycles of pain and build a present relationship with his son, Copper Alexander Martin Noise Cat, transforming their relationship into one of love and repair.
...
[[SUM]] Attachment styles, persisting from infancy, are categorized by comfort with intimacy and sensitivity to danger: anxious individuals desire closeness but fear rejection; avoidant individuals desire relationships but are uncomfortable with too much intimacy; secure individuals are comfortable with both intimacy and autonomy; and fearful-avoidant individuals desire closeness but are highly sensitive to danger.
...
[[SUM]] Attachment is a dynamic spectrum, not a fixed category, meaning individuals can exhibit different styles with different people and can learn to live in a "secure mode" by establishing a stable "social baseline" through understanding their "attachment topography."
...
[[SUM]] Longitudinal studies show parental behavior has only a 3% impact on adult attachment, while early friendships contribute 11%, challenging the overemphasis on childhood causality and highlighting the potential for change in the present.
...
[[SUM]] Attachment styles are self-defeating "scripts" that can be rewritten through Secure Priming Therapy, which helps individuals identify and focus on often-overlooked "secure kernels"—past or present positive relational experiences—to cultivate greater security.
...
[[SUM]] Minor social slights like exclusion sting profoundly because our social brain, wired for tribal survival, interprets them as a significant threat, activating ancient distress mechanisms regardless of conscious reasoning, as shown by the "Cyberball effect."
...
[[SUM]] The CARP framework—Consistent, Available, Responsive, Reliable, and Predictable—nurtures security by replicating "hyper-inclusion," leading to increased self-esteem and well-being, with predictability being crucial for maintaining a stable relational foundation.
...
[[SUM]] Two rules for secure engagement are: only one person should be upset at a time, with the other providing comfort; and if both get upset, both must apologize to prioritize emotional resolution and reconnection over winning an argument.
...
[[SUM]] To manage insecurity, individuals with anxious attachment can break the "Protest-Regret Cycle" by using "Wall Tennis with Love," responding consistently and lovingly to others' initiations without over-initiating, thus maintaining the attachment thread and achieving homeostasis.
...
[[SUM]] We are not trapped by past labels; change is always possible through self-acceptance, reorganizing our social environment, and practicing new behaviors, empowering us with agency to rewrite our relationship stories and cultivate a more secure life.
...
[[SUM]] GitHub는 AI 시대에 '개발자'의 정의가 확장되고 PR이 폭증함에 따라, 코파일럿 코드 리뷰와 에이전트 병합 같은 도구로 오픈소스 유지보수자의 부담을 줄이고 자율성을 보장하고 있다.

### '개발자'의 정의 확장

[[SUM]] GitHub는 과거 개발자로 불리지 않던 지식 노동자들도 코파일럿을 활용해 코드를 작성하면서 개발자의 정의가 확장되었고, 이에 따라 누구나 쉽게 코딩을 시작하도록 진입 장벽을 낮추는 데 집중하고 있다.
...
[[SUM]] AI 에이전트의 등장으로 풀 리퀘스트가 기하급수적으로 늘어나자, GitHub는 코파일럿 코드 리뷰와 에이전트 병합 도구를 제공하여 PR 처리 과정을 자동화하고 유지보수자에게 통제권을 부여하고 있다.
...
[[SUM]] GitHub는 월 1,700만 건의 AI 생성 PR 등 폭발적인 코드 증가를 '새로운 에이전트 경제'의 최전선으로 보고, 개발자들의 에이전트 활용을 지원하기 위해 대규모 투자를 진행 중이다.

### 코드 생성의 폭발적 증가와 미래 준비

[[SUM]] 지난 3월 AI 에이전트가 생성한 PR이 1,700만 건에 달하는 등 코드 생성이 폭발적으로 증가하고 있으며, GitHub는 모든 개발자의 '에이전트 순간'을 지원하는 핵심 인프라 역할을 할 것이다.
...
[[SUM]] AI 에이전트가 24시간 코드를 생성하는 환경에서 GitHub는 기존 프리미엄 모델 대신 사용량 기반 모델로의 전환 가능성을 시사하며, 개발자 성공을 위한 핵심 경험과 기업 고객의 대규모 운영을 지원할 것이다.
...
[[SUM]] GitHub COO 카일 데이글은 마이크로소프트 개발자 CMO 역할까지 겸하며, 개발자 중심 철학을 전파하고 다양한 AI 모델 및 코딩 에이전트 파트너들과 협력하여 개발자에게 선택의 폭을 넓혀주는 것을 핵심으로 삼고 있다.

### GitHub COO와 마이크로소프트 개발자 CMO의 이중 역할

[[SUM]] 카일 데이글은 GitHub의 개발자 중심 철학을 마이크로소프트 전체에 전파하며, 모든 개발자 도구와 기술을 아우르는 '진정성 있는' 통합 솔루션을 제공하는 데 주력하고 있다.
...
[[SUM]] GitHub는 '개발자 선택'과 '빌더를 위한 구축'에 집중하며, 개발자들이 GitHub와 함께 다른 도구들을 자유롭게 사용할 수 있도록 지원하여 '벽으로 둘러싸인 정원'이 아닌 유연한 생태계를 제공하는 것을 차별점으로 삼는다.
...
[[SUM]] GitHub는 제품 개발에 '힐 클라이밍' 방법론을 적용하여 사용자 데이터를 기반으로 모델을 지속 개선하며, 개인적으로도 AI 클론을 활용해 자기 개선 루프를 구축하고 있다.

### 제품 개발과 '힐 클라이밍(Hill Climbing)' 방법론

[[SUM]] GitHub는 '힐 클라이밍' 방법론을 통해 좋아요/싫어요 데이터, 코드 수락률 등 방대한 사용자 데이터를 분석하여 모델을 지속적으로 개선하고, 정량적 지표와 사용자 감성을 함께 고려한다.
...
[[SUM]] GitHub는 '모델 라우터'와 같은 기술을 통해 작업 의도에 따라 적절한 AI 모델을 자동으로 선택하게 하여 토큰 비용을 절감하고, 개인 개발자에게도 큰 도움이 될 것으로 기대한다.
...
[[SUM]] 카일 데이글은 자신이 작성하는 모든 것을 읽고 피드백을 주는 AI 클론을 활용하여 글쓰기 및 말하기 습관을 개선하고 있으며, AI가 인간의 '재귀적 자기 개선'을 돕는 강력한 파트너가 될 수 있음을 강조한다.
...
[[SUM]] 생성형 AI는 인종차별적 고정관념을 강화하고 착취하며, 특정 감정을 유발하도록 설계된 콘텐츠로 금전적 이득을 취한다.

### 논란의 중심에 선 'Phenomenal Black Woman'

[[SUM]] AI가 생성한 'Phenomenal Black Woman' 노래는 흑인 커뮤니티에서 감동을 주지만, 브리짓 토드는 이를 '가짜 같고, 치즈 같고, 진부하다'고 비판한다.
...
[[SUM]] AI 콘텐츠는 자부심, 공감뿐 아니라 혐오, 짜증 등 강렬한 감정을 유발하도록 설계되며, 극단적인 반응을 끌어내려 한다.
...
[[SUM]] AI 콘텐츠는 흑인 커뮤니티의 연대감을 악용하거나, 특정 집단에 대한 기존 편견을 강화하며 사기 및 정치적 선전을 확산한다.

### '손수 만든 가방' 사기: 감성 팔이 뒤에 숨겨진 진실

[[SUM]] 어린 흑인 아이가 만든 수공예품을 내세운 AI 영상은 흑인 커뮤니티의 유대감을 악용하여 대량 생산된 저렴한 상품을 파는 드롭쉬핑 사기이다.
...
[[SUM]] AI 영상은 뉴욕 시장 선거 광고처럼 부정적 이미지를 조장하거나, SNAP 혜택 중단 관련 영상처럼 '복지 여왕' 고정관념을 강화하며 정치적 목적에 악용된다.
...
[[SUM]] AI가 인종적 고정관념을 이용하는 '디지털 블랙페이스'는 민스트럴 쇼와 유사하게 강한 감정적 반응을 유발하여 수익을 얻거나 성인 콘텐츠로 연결된다.
...
[[SUM]] 리즈 위더스푼처럼 여성에게 AI 사용을 독려하는 것은 시스템적 문제를 개인의 책임으로 전가하며, 여성의 AI 회의론은 감시와 부담 증가에 기인한다.

### AI 도입을 둘러싼 성별 격차의 오해

[[SUM]] 여성들이 AI에 회의적인 것은 '멍청하거나 두려워서'가 아니라, 환경적 우려와 소수자로서 직장에서 더 많은 감시를 받는 현실을 이해하기 때문이다.
...
[[SUM]] 인플루언서들이 여성에게 AI 학습을 독려하는 것은 AI 기술 인프라의 문제점을 가리고, 개인의 책임으로 돌려 자신의 사업 이윤을 높이는 방식이다.
...
[[SUM]] AI의 부정적 영향에 대한 제도적 보호가 미흡한 상황에서, 개인은 비판적 사고로 AI 콘텐츠를 대하고 스스로를 보호해야 한다.

### 출판계의 AI 스캔들: '굿리즈 사건'부터 '샤이 걸'까지

[[SUM]] '굿리즈 스캔들'과 '샤이 걸' AI 논란은 출판사들이 AI 사용 정책이 없어 작가들이 피해를 입는 불공정한 구조를 보여준다.
...
[[SUM]] 개인은 강렬한 감정을 유발하는 AI 콘텐츠에 '누가 이득을 얻는가' 질문해야 하지만, 궁극적으로는 더 윤리적이고 공정한 AI 시스템 구축이 필요하다.
...
[[SUM]] 줄리안은 아버지와 '대마초 스크래블' 게임을 하며 유머와 솔직한 대화를 통해 부자 관계를 재건하고, 아버지를 자신의 인생에서 가장 큰 영향을 미친 '메인 캐릭터'로 이해하게 됩니다.
...
[[SUM]] 줄리안의 아버지 에드는 원주민 기숙학교에서 태어나 알코올 중독으로 가족을 떠났지만, 유명한 예술가이자 카리스마 넘치는 '트릭스터 코요테' 같은 존재로 줄리안에게 복잡한 영향을 주었습니다.
...
[[SUM]] 줄리안은 아버지와 함께 살며 원주민 기숙학교의 비극과 아버지의 충격적인 출생 비밀('베이비 X')을 알게 되고, 대물림된 트라우마가 아버지의 행동에 미친 영향을 이해합니다.
...
[[SUM]] 줄리안은 원주민 문화의 '트릭스터 코요테' 메타포를 통해 아버지를 '창조자이자 파괴자, 생존자이자 무책임한 아버지'로 이해하며, 잃어버렸던 문화적 유산을 되찾고 관계의 복잡성을 받아들입니다.
...
[[SUM]] 아버지는 줄리안의 책을 읽고 비로소 과거의 부재에 대해 사과했으며, 줄리안은 자신이 아버지처럼 33세에 아들을 낳게 되면서 세대 간의 고통을 끊고 새로운 시작을 다짐합니다.
...
[[SUM]] 줄리안은 아버지가 된 후, 아버지와의 관계가 '깨어지고 고통스러운 이야기'에서 '사랑과 회복의 이야기'로 변했음을 깨닫고, 아들에게 마법 같은 관계를 만들어주며 치유의 여정을 이어갈 것을 다짐합니다.
...
[[SUM]] 애착 유형은 타인과의 친밀감, 관계 속 위험 민감도를 나타내며, 라빈 박사는 애착 유형이 삶의 고통과 치유의 근간이라고 강조한다.

라빈 박사는 애착 유형이 우리가 타인과 얼마나 편안하게 친밀감을 느끼는지, 그리고 관계 속에서 잠재적 위험에 얼마나 민감하게 반응하는지를 나타내는 지표라고 설명합니다.

### 애착 이론의 발견과 성인 애착

[[SUM]] 애착 이론은 아기 연구에서 시작되었으나, 라빈 박사는 성인도 평생 애착 스타일을 유지하며, 크게 세 가지 유형으로 나뉜다고 설명한다.
...
[[SUM]] 불안정형은 상대의 가용성에 불안해하고, 회피형은 독립성을 추구하며 거리를 두려 하며, 안정형은 친밀감을 사랑하지만 위협에 덜 민감하다.
...
[[SUM]] 공포-회피형은 친밀함을 갈망하면서도 관계 속에서 잠재적 위험에 매우 민감하게 반응하여 모순적인 태도를 보인다.
...
[[SUM]] 애착 유형은 고정된 범주가 아닌 스펙트럼이며, 시간이 지나며 변화할 수 있고, 우리 모두 '안정형 모드'로 살아가는 법을 배울 수 있다.
...
[[SUM]] 심리적 안정감은 '안정성(Stability)'에서 오며, 안정형 애착은 뇌가 돌아올 수 있는 안정적인 '사회적 기준선(social baseline)'을 찾는 과정과 연결된다.

그렇다면 심리적, 정서적 안정감의 가장 중요한 차원은 무엇일까요? 라빈 박사는 이를 '안정성(Stability)'이라고 말합니다.

### 심리적 안정은 '안정성(Stability)'에서 온다

[[SUM]] 인간은 생물학적으로 항상성(homeostasis)을 추구하며, 뇌는 안전한 사회적 기준선을 찾아 안정감을 얻으려 한다.
...
[[SUM]] 라빈 박사는 '안정형 뇌'가 무엇을 필요로 하고 '사회적 뇌'가 싫어하는 것을 이해하면 타고난 애착 스타일과 상관없이 '안정형 모드'로 살 수 있다고 말한다.
...
[[SUM]] 성인 애착이 어린 시절 가족 역학에 의해 결정된다는 통념은 잘못되었으며, 30년 연구 결과 부모 영향은 3%, 어린 시절 우정은 11% 기여했다.
...
[[SUM]] 우리는 자신에 대한 '이야기'에 갇히기 쉬우나, '안정형 점화 치료'를 통해 무시했던 '안정형 잠재력'을 인식하고 새로운 서사를 만들 수 있다.
...
[[SUM]] 뇌는 사회적 연결에 대한 깊은 욕구를 가지며, 배제당하는 것에 극도로 민감하게 반응하여 신체적 고통과 유사한 반응을 보인다.

우리의 뇌는 사회적 연결에 대한 깊은 욕구를 가지고 있으며, 배제당하는 것에 극도로 민감하게 반응합니다.

### 사회적 배제는 왜 아픈가? 사이버볼 효과(Cyberball Effect)

[[SUM]] 가상 공놀이 게임인 '사이버볼 효과' 실험에서 사회적 배제는 신체적 고통과 관련된 뇌 영역을 활성화시키고 자존감 저하를 유발했다.
...
[[SUM]] 애착은 '안전 레이더'와 같아, 문자 무응답 같은 '미세 상호작용'에도 뇌는 연결의 끈이 단단한지 확인하며 생존과 연결된 본능적 반응을 보인다.
...
[[SUM]] '역 사이버볼' 실험에서 '초과 포함'은 뇌를 '천국'처럼 반응하게 하며, 'CARP'(Consistent, Available, Responsive, Reliable, Predictable) 원칙으로 일상에서 이를 조성할 수 있다.
...
[[SUM]] 안정형 모드로 살기 위해 라빈 박사는 관계 갈등 해결을 위한 '안정형 참여의 두 가지 규칙'과 '사랑을 담은 벽 테니스' 같은 실용적인 도구를 제안한다.

그렇다면 어떻게 이 '안정형 모드'로 살아가는 법을 배울 수 있을까요? 라빈 박사는 몇 가지 실용적인 규칙과 도구를 제안합니다.

### '안정형 참여의 두 가지 규칙(Two Rules of Secure Engagement)'

[[SUM]] 규칙 1은 한 번에 한 사람만 화낼 수 있으며 다른 사람이 진정시켜야 하고, 규칙 2는 둘 다 화났다면 둘 다 사과해야 한다는 것이다.
...
[[SUM]] 불안정형을 위해 상대가 먼저 상호작용하면 사랑으로 반응하되, 과도하게 먼저 시작하지 않으며, 다른 안정형과 소통하여 애착 시스템을 안정화한다.
...
[[SUM]] 애착 패턴을 운명으로 받아들이기보다, 자신의 생물학적 특성을 수용하고 더 나은 삶의 방식을 찾으려는 '주체성'에서 진정한 변화가 시작된다.
...
[[SUM]] 애착 유형은 변화 가능한 스펙트럼이며, 'CARP' 원칙, '안정형 참여 규칙', '사랑을 담은 벽 테니스' 같은 전략을 통해 '안정형 모드'로 전환하여 건강한 관계를 만들 수 있다.
