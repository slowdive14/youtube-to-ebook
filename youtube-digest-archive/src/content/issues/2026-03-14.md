...
[[SUM]] Our subjective "manifest time" is elastic, stretching or compressing based on experience, contrasting with physics' historical belief in Newton's rigid "Absolute Time" before Einstein.
...
[[SUM]] Einstein's theories of relativity proved time is not universal but relative to the observer and affected by speed and gravity, meaning your head is infinitesimally older than your feet.
...
[[SUM]] Relativity implies no universal "Now," leading many physicists to the "Block Universe" theory (Eternalism), where all past, present, and future moments coexist simultaneously, raising questions about free will.
...
[[SUM]] The "problem of time" peaks with the Wheeler-DeWitt equation, where the time variable vanishes, suggesting time might be an "emergent property" rather than fundamental.
...
[[SUM]] Despite time-symmetric fundamental laws, the universe has an "Arrow of Time" due to the Second Law of Thermodynamics (increasing entropy) and, more fundamentally, irreversible Quantum Decoherence.
...
[[SUM]] Jim Al-Khalili believes time is real, grounded in quantum interactions, even if we can't objectively view its flow, making it the fundamental stage for existence.
...
[[SUM]] Modern scam operations, particularly in Southeast Asia, function like corporations with HR, legal, and marketing departments, often forcing trafficked victims to run "boiler rooms" and test scam scripts.
...
[[SUM]] While older adults lose more money per incident, middle-aged adults report victimization most frequently, with different demographics targeted by specific scam types, and the psychological toll can tragically lead to suicide.
...
[[SUM]] Scams often appear obvious with typos and far-fetched premises to filter out skeptics, ensuring only the most gullible individuals respond, thereby increasing conversion rates and minimizing labor costs.
...
[[SUM]] Scammers exploit human psychology by inducing high positive or negative emotional arousal to shut down analytical System 2 thinking, forcing reliance on mental shortcuts and compliance.
...
[[SUM]] AI is making scams more sophisticated, generating perfect prose and deepfake videos, while scammers exploit legitimate institutional bureaucracy and readily available personal information to deceive victims.
...
[[SUM]] Accountability for fraud is shifting towards platforms that enable scams, with regulators targeting "facilitators" like payment processors, and critics arguing Big Tech companies are not doing enough despite their technical capacity.
...
[[SUM]] The constant barrage of fraud is eroding social trust, leading people to treat all unsolicited communication as a lie, necessitating independent validation of every claim to avoid being scammed.
...
[[SUM]] OpenAI's "YOLO" approach of securing massive, long-term compute contracts early on gave them a significant advantage over Anthropic, whose conservative strategy led to compute constraints and higher premium costs for last-minute acquisitions.
...
[[SUM]] The Alchian-Allen Effect explains why rising compute costs are increasing the value of older GPUs and driving revenue towards frontier models, as the fixed cost makes investing in the best models more rational.
...
[[SUM]] Beyond chips, the real bottlenecks include securing power turbines for future data centers and the physical limits of the silicon supply chain, requiring massive wafer production and millions of EUV passes.
...
[[SUM]] ASML, the sole producer of $400 million EUV lithography machines that use tin droplets and lasers to print circuits at 13.5 nanometers, is the ultimate gatekeeper, with limited annual production capacity of only around 70-100 machines.
...
[[SUM]] A critical disconnect exists between "AGI-pilled" AI labs, who see GPUs as immediate "workers," and skeptical semiconductor manufacturers, who hesitate to build expensive fabs due to past boom-and-bust cycles, creating an ultimate bottleneck for AGI development.
...
[[SUM]] Following the Cold War and the "Last Supper" meeting in the early 1990s, the U.S. defense industrial base consolidated to a few "primes," leading to a reliance on outsourced production and a need to catch up with adversaries like China.
...
[[SUM]] The Under Secretary simplified the Pentagon's 14 critical priorities to six, with Applied AI at the top, aiming to integrate AI for enterprise efficiency, intelligence augmentation, and warfighting/logistics, which rapidly increased AI usage among personnel.
...
[[SUM]] A "holy cow" moment revealed commercial AI models with "Terms of Service" and "Corporate Constitutions" that could restrict military operations, highlighting a dangerous vendor lock-in where a company's values might conflict with national security.
...
[[SUM]] To address this, the Pentagon is adopting the "Elon Model" of "Firm-Fixed-Price" contracts with simple requirements, challenging startups to develop mass production capabilities to complement their innovation.
...
[[SUM]] The Under Secretary, a former tech executive, views this moment as a call to service for the tech industry, urging patriotic builders to contribute their expertise to protect the American way of life and ensure the U.S. maintains its technological edge.
...
[[SUM]] One ten-page story in Louise Erdrich's new collection took eight years to complete, as she describes her writing process as a slow "army crawl" driven by curiosity and returning to drafts only when a line hooks her.
...
[[SUM]] Erdrich states that a story's form—poem, children's book, or novel—"announces itself," evolving outside her conscious will, a process she began in fifth grade to cope with being overwhelmed by the world.
...
[[SUM]] When stuck, Erdrich physically crawls through scattered notebooks and notes on the floor to order her thoughts, a humble act reflecting her belief that awards go to the book and her grandfather, not her.
...
[[SUM]] Erdrich's literary foundation comes from a family tradition of prolific letter writing, with her grandfather's letters providing the "personality" for *The Night Watchman* protagonist, proving the written word's power to preserve a soul.
...
[[SUM]] As owner of Birchbark Books since 2001, Erdrich has witnessed an "explosion" of Indigenous voices, fulfilling a prophecy that diverse tribal stories would reveal the richness of the Native experience, recommending James Welch's *Winter in the Blood*.
...
[[SUM]] Erdrich maintains that creation remains a mystery, feeling detached from her own writing as if it comes from "some other world, some other entity," preferring to follow the next sentence rather than be a "literary figure."
...
[[SUM]] 우리가 뇌로 지각하는 '현상적 시간'은 주관적이지만, 물리학 방정식 속 '물리적 시간'은 흐름이나 방향성 없이 좌표나 숫자에 불과하다.
...
[[SUM]] 아인슈타인의 상대성 이론에 따르면 시간은 관찰자의 속도(특수 상대성 이론)와 중력(일반 상대성 이론)에 따라 다르게 흐르며, 이는 GPS 보정 등 실제 현상으로 증명된다.
...
[[SUM]] 과거, 현재, 미래가 이미 결정된 '블록 우주' 모델에서 인간의 자유 의지는 역설적으로 보이지만, 우리는 미래를 예측할 수 없기에 선택은 여전히 자유롭다.
...
[[SUM]] 우주 전체를 설명하는 휠러-드윗 방정식에 시간 변수가 없어, 시간은 양자 수준의 더 근본적인 무언가에서 비롯된 '창발적 속성'일 수 있다는 주장이 제기된다.
...
[[SUM]] 시간이 한 방향으로만 흐르는 이유는 엔트로피 증가 때문이며, 알칼릴리 교수는 양자 얽힘과 결어긋남을 통해 시간의 화살이 우주의 근본 구조에 각인되어 있다고 주장한다.
...
[[SUM]] 시간이 더 깊은 원리에서 창발되었더라도, 시간의 방향성과 흐름이 물리적으로 증명되는 한 시간은 실재하며, 이는 우주의 본질적 질문에 답하는 데 중요하다.
...
[[SUM]] 사기는 연간 190억 달러 규모의 수익을 내는 캄보디아 GDP 절반에 육박하는 거대 산업으로, 마케팅, IT, HR, 법무팀까지 갖춘 기업형 조직이며, 인신매매된 강제 노동자를 동원해 A/B 테스트로 실적을 압박합니다.
...
[[SUM]] 사기는 노인뿐 아니라 모든 연령층을 대상으로 하며, 사기꾼들은 우리의 논리적 사고(시스템 2)를 마비시키고 감정적 판단(시스템 1)을 유도하기 위해 공포나 기대감 같은 '정서적 각성'을 활용합니다.

미국 미네소타 대학교의 노년학자 마티 드 리마(Marty De Lima) 교수는 사기가 노인들만의 문제라는 통념을 정면으로 반박합니다.

#### **세대별 타겟팅의 차이**

[[SUM]] 청년층은 가짜 구인/쇼핑, 중장년층은 사기 피해 신고율이 가장 높고, 고령층은 기술 지원/복권 사기 표적이며 자산 규모가 커 1인당 피해액이 가장 큽니다.
...
[[SUM]] 사기꾼들은 '시스템 2'(이성)를 끄고 '시스템 1'(본능)으로 판단하게 만들고자 긍정적/부정적 '정서적 각성'을 유도하여 논리적 사고를 방해합니다.
...
[[SUM]] AI는 챗GPT로 완벽한 문법과 자연스러운 말투를 구사하고, 딥페이크와 음성 복제로 신뢰를 얻으며, 수억 명에게 개인화된 메시지를 보내는 자동화된 대규모 사기 공격을 가능하게 합니다.
...
[[SUM]] 메타 매출의 10%가 사기 광고에서 나온다는 분석처럼, 거대 IT 플랫폼들은 기술적으로 사기 계정 차단이 가능함에도 비용 대비 수익을 따져 적극적으로 나서지 않아 범죄를 방치하고 있습니다.
...
[[SUM]] 사기는 '배신 트라우마'를 남기며 사회적 불신을 야기하므로, 모든 예기치 않은 연락을 의심하고, 독립적인 경로로 확인하며, 시간적 압박에 저항하고, 개인정보 유출 여부와 상관없이 사기를 의심해야 합니다.
...
[[SUM]] 사기 산업은 사회적 신뢰를 파괴하며, 개인의 주의를 넘어 국가적/국제적 공조, AI 기술을 활용한 사기 방지, 강력한 플랫폼 규제, 그리고 피해자를 비난하지 않는 문화가 필요합니다.
...
[[SUM]] 빅테크 기업들의 6,000억 달러 자본 지출은 미래 데이터 센터 건설, 발전기 예약, 장기 전력 구매 계약 등 '미래를 위한 자리 선점'에 주로 쓰이며, AI 매출 성장은 기하급수적인 컴퓨팅 용량 증설과 전력 수요 증가를 의미한다.
...
[[SUM]] 오픈AI는 공격적인 컴퓨팅 계약으로 자원을 선점한 반면, 앤스로픽은 보수적 확장으로 컴퓨팅 부족에 시달리며 불리한 조건으로 자원을 확보해야 했다.
...
[[SUM]] AI 모델 효율성 향상으로 H100 같은 AI 칩의 '지능 가치'가 상승하여 중고 가격이 오르고, A100 같은 5년 전 모델도 여전히 현역으로 활용되는 등 GPU의 수명 주기가 길어지고 있다.
...
[[SUM]] AI 확장의 가장 큰 병목은 ASML의 EUV 노광 장비 생산량(연 70~80대)으로, 1GW 데이터 센터에 필요한 EUV 장비 수를 고려할 때 AI 발전 속도는 ASML의 생산 능력에 달려있다.
...
[[SUM]] 구글은 초기 AI 수요를 과소평가하여 앤스로픽에 TPU 용량을 판매했고, 이후 자체 딥마인드 팀의 컴퓨팅 자원 부족을 깨닫고 뒤늦게 전력 확보와 칩 생산에 집중하게 되었다.
...
[[SUM]] 마락비 CTO는 국방부의 혁신 속도가 민간에 뒤처져 있음을 직시하며, 현재 상황을 '역사상 최대 규모의 군비 증강 경쟁'으로 규정했다.
...
[[SUM]] 루이즈 어드리크는 10페이지 분량의 소설을 8년 걸려 완성하는 등, 숲 바닥을 기어가는 군인의 포복처럼 느리고 물리적인 방식으로 글을 쓴다.
...
[[SUM]] 그녀는 이야기가 스스로 소설이 될지 단편이 될지 결정하며, 작가의 의지나 통제 밖에서 일어나는 예술적 불확실성을 편안하게 받아들인다.
...
[[SUM]] 어린 시절 노스다코타의 핵 미사일 기지 옆에서 자라며 느낀 핵전쟁의 공포가 초등학생 때부터 일기를 쓰게 된 계기였다.
...
[[SUM]] 안톤 체호프를 가장 존경하며, 로런 그로프의 「브롤러」를 읽고 눈물 흘렸던 경험을 통해 예술이 작가의 통제를 벗어날 때의 신비로움을 강조한다.
...
[[SUM]] 25년간 운영한 독립 서점 '버치바크 북스'를 통해 원주민 문학이 폭발적으로 성장하여 서점 전체를 원주민 작가 책으로 채울 수 있게 되었다고 말한다.
...
[[SUM]] 불면증을 위한 책으로 세이 쇼나곤의 『마쿠라노소시』를 추천하고, 상투적 표현에 민감하며 『골프장을 공공 섹스 숲으로 만들자』 같은 파격적인 책도 읽는다.
