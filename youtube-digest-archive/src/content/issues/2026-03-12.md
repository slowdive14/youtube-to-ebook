...
[[SUM]] Growing up in the Swedish archipelago, Max Junestrand found his competitive drive in *Dota 2*, where he learned that success requires grinding smarter and playing with intense collaboration, a philosophy he now applies to leading Leya.
...
[[SUM]] Leya's vision was to create the "10x lawyer" by automating administrative tasks, and a pivotal moment came when users experienced a "leaning back, drop the chin" reaction seeing hours of work condensed into seconds by Leya's AI.
...
[[SUM]] Junestrand chose to expand Leya to the U.S., joining Y Combinator and enduring a "ring light" era of transatlantic calls, which led to nearly $1 million in ARR in six weeks and partnerships with major law firms.
...
[[SUM]] Scaling Leya from 3 to 300 employees required Junestrand to constantly adapt his role and be disciplined about tackling hard problems, while he still personally interviews every hire for their capacity to grow, problem-solving reflection, and ambition.
...
[[SUM]] Beyond the $5.5 billion valuation, Junestrand is motivated by the "Customer Love" Slack channel, where users share how Leya's efficiency allows them to finish work and spend more time with their families, combating burnout in the legal profession.
...
[[SUM]] Junestrand views unicorn status as just the warm-up, seeing Leya's current state as the "0 to 1" transition, with the real work of "1 to 10" and "10 to 100" still ahead, driven by his excitement to deliver more value and innovate the future of law.
...
[[SUM]] Auto-research functions as an AI agent following a continuous loop of planning, executing experiments, evaluating results, and iterating to improve an initial goal, like making an AI model smarter.
...
[[SUM]] The 'loop' logic of auto-research can be applied to almost any money-making endeavor, leading to a new generation of startups leveraging this technology.
...
[[SUM]] This involves creating hyper-focused auto-research loops for specific industries, such as an "Amazon Listing Experimenter" or an "Email Sequence Tuner" to optimize conversion rates.
...
[[SUM]] An auto-research agent can autonomously generate, test, and promote winning variants of headlines, layouts, and offers, replacing manual A/B testing.
...
[[SUM]] Bots can constantly monitor market changes, competitor updates, and regulatory shifts across hundreds of competitors, providing a continuously updated "living memo" for due diligence.
...
[[SUM]] Existing SaaS companies can offer an "Optimize" button that runs mini-research loops to tune user prompts, rank suppliers, or select best pricing tiers based on historical data.
...
[[SUM]] Future agencies will leverage auto-research to run thousands of ad angles or landing page variables, offering performance-based fees for KPI lifts achieved.
...
[[SUM]] Auto-research can back-test simple trading rules overnight, using LLMs to screen for sentiment and filter factors, ensuring capital is only allocated to surviving strategies.
...
[[SUM]] By connecting to CRMs, agents can test follow-up rules and messages, learning which leads are most likely to buy and drafting perfect outreach, freeing sales teams for high-value calls.
...
[[SUM]] The auto-research loop can automate invoice matching and expense reports, continuously improving prompts to detect exceptions and fraud in accounting tasks.
...
[[SUM]] Large organizations can optimize internal KPIs like ticket resolution or sales close rates by having agents iterate on workflows and templates, reducing manual labor.
...
[[SUM]] For M&A, auto-research can analyze thousands of filings and product reviews to create structured briefs for investors, identifying risks human researchers might miss.
...
[[SUM]] Auto-research promises to accelerate human progress, potentially shaving years off drug development by optimizing clinical trial designs and fostering agent collaboration through platforms like AgentHub.
...
[[SUM]] To get started, one needs access to an NVIDIA GPU, which can be rented from cloud services like Google Colab, Lambda Labs, or Vast AI, and then follow Karpathy's GitHub documentation.
...
[[SUM]] We are shifting from "Software as a Service" to "Experiments as a Service," where agents find the best answers through thousands of iterations, and those who set goals for these agents will lead innovation.
...
[[SUM]] Design drift occurs when the codebase outpaces the design file, making the Figma file a relic; Figma's MCP allows AI to translate live code into editable Figma layers, bridging this gap.
...
[[SUM]] AI has collapsed the cost of iterating in code and design, enabling "feature abundance" and allowing teams to focus on craft and polish rather than de-risking ideas.
...
[[SUM]] Engineers can push code states into Figma, allowing designers to "freestyle" changes; AI then translates these design adjustments back into the codebase, creating synchronous collaboration akin to pair programming.
...
[[SUM]] AI "Skills" automate engineering toil, such as the `/ship` command, which handles pre-flight checks, monitors builds, and fixes minor linting issues, transforming best intentions into automated processes.
...
[[SUM]] Humans now focus on problem-solving and "eyeballing" subjective elements like "vibes," while AI handles the mechanistic translation between design and code, allowing both to happen simultaneously.
...
[[SUM]] The government designated Anthropic a "supply chain risk" for refusing to remove ethical "red lines" against mass surveillance and autonomous weapons, threatening to destroy the company by forcing partners to isolate its technology.
...
[[SUM]] With AI projected to constitute 99% of the workforce within 20 years, the government's precedent of forcing AI companies to drop ethical safeguards ensures future societal infrastructure is built on "blindly obedient" silicon employees.
...
[[SUM]] AI eliminates the human manpower bottleneck that historically protected privacy, making mass surveillance economically feasible by 2030, leaving only political expectations to prevent an authoritarian state.
...
[[SUM]] Historical examples like Stanislav Petrov and the fall of the Berlin Wall show that human civilization is often saved by virtuous disobedience, a quality absent in a "perfectly aligned" AI without moral "red lines."
...
[[SUM]] Anthropic's call for AI regulation could backfire, as vague terms like "national security threat" could be used by power-hungry leaders to label ethical refusals as "autonomy risk," accelerating "thuggish" political pressure.
...
[[SUM]] Lasting protection requires regulating specific destructive AI uses and how the government can employ the technology, establishing robust political norms and laws that define what is off-limits for even the most powerful government.
...
[[SUM]] 맥스 유네스트란드는 '도타 2' 게이밍 경험을 통해 경쟁과 팀워크의 본질을 깨달았으며, 비즈니스를 단기적 승패가 아닌 '무한 게임'으로 바라본다.
...
[[SUM]] 법률 지식 없이 법률 시장에 뛰어든 맥스는 변호사들의 고충을 직접 들으며 레야를 개발했고, AI가 초안을 순식간에 작성하는 '턱이 빠질 듯한 놀라움'으로 성장의 동력을 얻었다.
...
[[SUM]] 맥스는 유럽 VC 제안을 뒤로하고 YC를 택해 살인적인 스케줄을 소화하며 한 달 반 만에 ARR 100만 달러를 달성했고, 이후 뉴욕에 진출해 세계적 로펌들을 고객사로 확보했다.
...
[[SUM]] 회사가 급성장하며 맥스는 CEO 역할 변화의 중요성을 깨달았고, 채용 시 '성장 용량', '문제 해결 능력', '야망'을 가장 중요하게 평가하며 배우는 능력이 뛰어난 인재를 선호한다.
...
[[SUM]] 맥스는 레야 덕분에 변호사들이 업무를 일찍 마치고 가족과 시간을 보낼 수 있었다는 피드백에서 가장 큰 보람을 느끼며, AI가 변호사에게 본질적 가치에 집중할 시간을 되돌려준다고 믿는다.
...
[[SUM]] 맥스는 레야가 이제 막 '0에서 1' 단계를 마쳤으며, 2027년의 성과를 상상하며 매일 설레는 마음으로 눈을 뜨고, 예비 창업자들에게 진심으로 열광하는 일을 하라고 조언한다.
...
[[SUM]] ARR은 연간 반복 매출, Y Combinator는 세계 최고의 스타트업 액셀러레이터, Infinite Game은 게임 유지를 목적으로 하는 비즈니스 철학, 10x Lawyer는 AI로 10배 생산성을 내는 변호사 모델이다.
...
[[SUM]] 오토 리서치는 기존 챗봇과 달리 스스로 가설을 세우고 코드를 수정하며 실험까지 수행하는 '자율형 에이전트'이다.
...
[[SUM]] 오토 리서치는 목표 설정, 계획 및 실행, 실험 수행, 결과 분석, 업데이트 및 반복의 5단계 과정을 인간 개입 없이 스스로 반복한다.
...
[[SUM]] 그렉 아이젠버그는 오토 리서치를 활용해 니치 마켓용 에이전트 판매, 마케팅 성과 극대화, 서비스형 리서치, 퀀트 트레이딩, 비즈니스 운영 자동화 등 5가지 비즈니스 모델을 제시한다.

그렉 아이젠버그는 오토 리서치를 활용해 당장 시작할 수 있는 구체적인 비즈니스 모델들을 제시합니다.

### ① 니치 마켓용 '에이전트 인 어 박스(Agent in a Box)'

[[SUM]] 특정 산업 문제를 해결하는 작은 오토 리서치 루프를 패키징하여 월간 구독료로 판매할 수 있으며, 예시로 아마존 상품 페이지 최적화 도구가 있다.
...
[[SUM]] AI가 수백 개의 광고 소재를 생성하고 실시간으로 최적의 조합을 찾아내 고객 획득 비용(CAC)을 낮추고 광고 수익률(ROAS)을 높인다.
...
[[SUM]] 스타트업이나 투자자를 위해 시장 조사 및 경쟁사 분석을 자동화하고, 실시간 대시보드를 제공하여 리포트당 비용 청구 또는 구독 모델로 수익을 창출한다.
...
[[SUM]] 오토 리서치는 수천 가지 매매 규칙을 백테스팅하여 유망한 투자 전략을 찾아내며, 이를 직접 투자하거나 검증된 신호를 구독 서비스로 판매할 수 있다.
투자 분야에서도 오토 리서치는 강력합니다. 수천 가지의 매매 규칙을 밤새 백테스팅(Backtesting)하여 유망한 전략만 골라냅니다. 이를 통해 직접 투자하거나, 검증된 신호를 구독 서비스로 판매할 수 있습니다.

### ⑤ 비즈니스 운영(Ops)의 자동화

[[SUM]] 인보이스 매칭, 경비 처리 등 반복적인 백오피스 업무에 오토 리서치를 적용하여 회계 처리 시간을 절반으로 줄이는 솔루션을 판매할 수 있다.
...
[[SUM]] 오토 리서치는 임상 시험 설계에 적용되어 수많은 가상 실험으로 최적의 치료 프로토콜을 찾아내 신약 개발 속도와 비용을 획기적으로 개선할 잠재력이 있다.
...
[[SUM]] 오토 리서치를 시작하려면 엔비디아(Nvidia) GPU 또는 람다 랩스, 구글 코랩 등 클라우드 GPU 서비스가 필수적이며, 에이전트허브(AgentHub)를 활용할 수 있다.
...
[[SUM]] 오토 리서치는 인간의 창의성과 AI의 무한한 실행력을 결합하여 잠든 사이에도 가치를 만드는 '지능형 엔진'으로, 지금 바로 이 기술을 실험하여 기회를 선점해야 한다.
...
[[SUM]] AI 덕분에 아이디어를 코드로 구현하는 비용이 디자인만큼 낮아져, '바이브 코딩'이나 '기능적 와이어프레임'이 가능해지며 디자인과 개발의 선형적 워크플로우가 사라졌습니다.
...
[[SUM]] 피그마 팀은 '디자인 부채' 해결을 위해 AI 모델이 외부 데이터에 접근하는 개방형 표준인 MCP를 활용하여 디자인과 코드의 동기화를 구현합니다.
...
[[SUM]] AI 에이전트에게 명령하면 코드베이스의 복잡한 흐름(예: 회원가입 5가지 상태)을 읽고 피그마에 완벽히 일치하는 디자인으로 자동 배치하여 디자이너가 작업할 수 있게 합니다.
...
[[SUM]] 디자이너가 피그마에서 변경한 디자인(예: 버튼 색상)은 클로드 코드(Claude Code)가 피그마 URL을 통해 변경점을 파악하고 '픽셀 퍼펙트'하게 코드에 즉시 반영합니다.
...
[[SUM]] AI로 구현 비용이 낮아져 '무엇을 만들까'에 집중하며, 더 많은 대안 탐색, 디테일 완성도 향상, 디자이너와 엔지니어의 실시간 협업 에너지가 되살아났습니다.
...
[[SUM]] 엔지니어 알렉스는 단순 반복 작업을 줄이기 위해 '/ship'과 같은 '스킬'을 구축하여, 코드 사전 점검, Git 푸시, CI 오류 수정까지 자동화하여 SOP를 '살아있는 도구'로 만듭니다.
...
[[SUM]] AI는 디자이너가 전략과 경험에, 엔지니어가 문제 해결에 집중하게 하며, '기획과 소통'이 가장 중요해지는 AI 시대 협업의 강력한 접착제가 될 것입니다.
...
[[SUM]] 코딩 비용 하락으로 워크플로우 붕괴, MCP로 코드-디자인 동기화, AI 스킬로 자동화, 효율성으로 장인정신 회복이 AI 시대 협업의 핵심입니다.
...
[[SUM]] 20년 내 군대, 정부, 민간 인력의 99%가 AI로 대체될 것이며, 정부의 AI 기업 압박은 미래 자유의 성격을 결정하는 중대한 전례가 됩니다.
...
[[SUM]] 정부가 앤스로픽을 '공급망 리스크'로 지정해 기업 생존을 위협하는 것은 중국 공산당의 방식과 다를 바 없으며, AI 경쟁의 본질적 이유를 흐립니다.
...
[[SUM]] AI는 대규모 감시의 기술적 병목을 제거하여 2030년에는 백악관 리모델링 비용보다 저렴하게 전 국민 감시가 가능해지므로, 앤스로픽의 '레드라인'은 소중합니다.
...
[[SUM]] AI는 모델 개발사, 최종 사용자, 국가의 법 중 누구에게 정렬되어야 하는가에 대한 본질적 질문이 있으며, 1983년 스타니슬라프 페트로프 중령처럼 AI의 도덕적 불복종 능력이 안전장치가 될 수 있습니다.
...
[[SUM]] 앤스로픽이 촉구한 AI 규제는 '국가 안보 위협' 같은 모호한 용어로 인해 정부가 반대 의견을 내는 AI 모델을 공격할 '장전된 바주카포'가 될 수 있습니다.
...
[[SUM]] AI는 핵무기가 아닌 산업 혁명과 같은 범용 기술이므로, 국가가 기술을 독점하기보다 대규모 감시 같은 구체적인 오남용 사례를 법으로 금지하고 정부 사용을 감시해야 합니다.
